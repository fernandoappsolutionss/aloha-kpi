...
//
// Entre semana, 3 slots fijos de 1 h con 30 min entre ellos (ajuste 2026: la
// parrilla arranca 3:30 pm — las 3:00 en punto daban problema):
//   3:30–4:30 · 5:00–6:00 · 6:30–7:30 pm
// La franja 2:00–3:00 pm es la ZONA KINDER (pareada L+M o M+J); queda
...
import { aMinutos, aHora12, chocanConBuffer, BUFFER_MIN, CIERRE_MIN } from './inventario'
import { INICIO_GRUPOS_DIA_PRUEBA } from './reservas'
import { DIAS } from './operaciones'

const H = (h, m = 0) => h * 60 + m

export const SLOTS_SEMANA = [
  { inicio: H(15, 30), fin: H(16, 30) }, // 3:30–4:30 pm
  { inicio: H(17), fin: H(18) },         // 5:00–6:00 pm
  { inicio: H(18, 30), fin: H(19, 30) }, // 6:30–7:30 pm
]
export const SLOT_KINDER = { inicio: H(14), fin: H(15) } // 2:00–3:00 pm (zona kinder 2:00–3:30)
...
export const RESUMEN_MODELO = `Lun+Mié y Mar+Jue 1 h (3:30, 5:00 o 6:30 pm) · Vie 4:30–6:30 pm · Sáb 9–11, 11:30–1:30 o 2–4 · Kinder solo 2:00–3:00 pm entre semana · 10 grupos por salón`
export { DIAS }
