...
// Solo marca los slugs de `permitidos` (los del módulo, no los 258), solo la
// PRIMERA aparición de cada término, y respeta límites de palabra con acentos:
// "facturación" no marca "factura".
