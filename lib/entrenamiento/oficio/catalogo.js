...
import { TODO_CARGO } from './cursos/roles.js'
...
//
// TODO_CARGO es el MISMO dato que llevan los `roles` de los módulos del bloque
// A (cursos/metodo.js y cursos/normativa.js): vive en cursos/roles.js para que
// no haya dos listas de puestos que se puedan desincronizar.
//
...
export const CURSOS = {
  ...
  // Solo ALOHA Los Naranjos (Venezuela): sus módulos llevan `centros`.
  fiscal:       { bloque: 'B', titulo: 'Materia fiscal (Los Naranjos)', roles: ['administradora', 'asistente'] },
...
export const ID_OFICIO = /^of-(met|nor|hat|zoh|cen|coa|cop|ase|fis)-[a-z0-9]+$/
