...
// clip se arma con su título, su primer párrafo y su producto final valioso.
...
export function metadatosOficio(m) {
  return {
    ...
    requiere: m.requiere || [],
    pfv: m.pfv || '',
    // El temario viaja con los metadatos porque el índice del hat lo usa para
    ...
    // Si el módulo trae su procedimiento ESCRITO a mano. El checksheet ofrece
    ...
    // módulos de método y hat imprimiría el temario bajo el título "Los pasos",
...
// en clave HCA: "Objetivo del Módulo" y "Temas del Módulo".
//
...
// El objetivo del módulo. En HCA el objetivo ES el Producto Final Valioso —
...
// El PFV solo se repite aparte cuando el objetivo NO es el PFV. Si no, la
