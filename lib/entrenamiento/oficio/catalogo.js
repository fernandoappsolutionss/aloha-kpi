...
// paquete del puesto); bloque B = el curso propio de cada puesto.
//
...
export const CURSOS = {
  metodo:    { bloque: 'A', titulo: 'Cómo se estudia a bordo',     roles: ['administradora', 'asistente'] },
  normativa: { bloque: 'A', titulo: 'Normativa de la empresa',     roles: ['administradora', 'asistente'] },
  hat:       { bloque: 'A', titulo: 'Tu puesto',                   roles: ['administradora', 'asistente'] },
...
// en la clave del Entrenamiento a Bordo: "Objetivo del Módulo" y "Temas del
// Módulo".
//
