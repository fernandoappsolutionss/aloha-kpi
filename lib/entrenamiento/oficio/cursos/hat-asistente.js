// Paquete del puesto — Asistente Administrativo. Un solo módulo: `of-hat-asi`.
...
export const HAT_ASI = [
  {
    ...
    orden: 13,
    roles: ['asistente'],
    titulo: 'Tu puesto: Asistente Administrativo',
    duracionMin: 20,
    requiere: ['of-nor-9'],
    fuente: [
    ...
    // Sin 'ciclo' ni 'ciclo-de-matricula' a propósito: el tope de palabras por
    // módulo es 12 y estas 12 son las del puesto. La Asistente ya aclara los dos
    // sentidos antes, en of-nor-1 ("Ciclos dentro del Programa", módulo 4 de su
    // plan contra el 13 de este), y vuelve sobre el comercial en of-zoh-3, que
    // es donde factura la matrícula del primer ciclo.
    palabras: ['puesto-en-cubierta', 'producto-final-valioso', 'checksheet', 'drill', 'oficial-de-entrenamiento', 'prima-de-produccion', 'indicador', 'falta-grave', 'administrador-de-centro', 'coordinador-operativo', 'junta-directiva', 'corporativo-aloha'],

    bloques: [
      { t: 'sub', texto: 'Qué es esto' },
      { t: 'p', texto: 'Esto no es un instructivo más. Esto es **tu puesto**: tu cargo y todo lo que trae. Aquí está qué produces, qué decides, qué NO decides, de quién recibes, a quién entregas y en qué orden se te entrena.' },
      { t: 'p', texto: 'Aquí el entrenamiento no busca que memorices. Busca que entiendas y puedas aplicar. Una persona con su puesto tomado se corrige sola, rápido, sin que nadie tenga que estarla persiguiendo. Eso es lo que le da estabilidad al Centro entero.' },
      ...
      { t: 'sub', texto: 'Las responsabilidades del puesto' },
      ...
      { t: 'nota', tono: 'regla', titulo: 'Regla clave', texto: 'Tú propones, coordinas, ejecutas y documentas. Las decisiones de esta tabla no son tuyas. Llevarlas a quien le toca no es debilidad: es tu puesto funcionando bien.' },
      {
        t: 'tabla',
        ...
        filas: [
          ...
          ['Elaborar contratos de personal', 'Coordinador Operativo (el Administrador solicita)', 'Nada. No es de tu puesto'],
    ...
    quiz: [
      {
        pregunta: '¿Cuál es el producto de tu puesto como Asistente Administrativo?',
        opciones: [
      ...
      },
      {
        ...
        explicacion: 'Tú propones, coordinas, ejecutas y documentas. Esa decisión no es tuya, y llevarla a quien le toca es tu puesto funcionando bien.',
    ...
    drills: [
      {
        ...
        proposito: 'Que puedas decir el producto de tu puesto sin leerlo, nombrar los cuatro sub-productos y dar el número de cada uno en tu Centro este mes, señalando el documento que lo respalda.',
        gradiente: 'Es el paso 6 de tu plan de puesto: exige el paso 5 (estudiar los bloques 1 a 4 de este paquete) aprobado. Si contestas con una lista de tareas, el paso no está aprobado y se vuelve al paso 5, no se repite esta.',
        masa: [
          'Ninguna. De memoria.',
        ...
        pasos: [
          ...
          'Di cuál de los cuatro está más flojo hoy y qué maniobra vas a repetir para levantarlo.',
        ],
        criterios: [
          ...
          'Identifica por sí misma el sub-producto más débil y la maniobra a la que va a volver, sin que su jefe entrenador se lo diga.',
        ],
        errorTipico: 'Contestar la pregunta "¿cuál es tu producto?" con una lista de tareas o con "atender a los padres". No tiene su puesto tomado, aunque tenga todas las casillas firmadas: se devuelve al estudio del paquete del puesto.',
      },
      {
        ...
        gradiente: 'Es el paso 5 de tu plan de puesto: exige haber estudiado los bloques 1 a 4 de este paquete, con el Manual de Operaciones abierto en la sección del puesto. Si fallas, el hueco está en el bloque de "lo que este puesto NO hace", no en la maniobra.',
        masa: [
