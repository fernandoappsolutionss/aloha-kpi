...
export const HAT_COP = [
  {
    ...
    // LA HOJA DE UNA PÁGINA. Los pasos son las DIEZ MENCIONES del Manual puestas
    // en el orden en que ocurren, más los dos frentes de gobierno del cierre de
    // mes. Se escribe a mano y no se deriva a propósito: la hoja derivada de un
    // paquete de puesto imprime el temario bajo el título "Los pasos", que es una
    // taxonomía y no un procedimiento, y además no cabía en la página.
    sop: {
      proceso: 'Tu puesto: Coordinador Operativo',
      cuando: 'Cada mes, y el día en que te llega cada trámite.',
      producto: 'Centros que cumplen el Manual y números que cuadran: cada colaborador con su contrato sellado e inscrito, cada centro con su gente entrenada y su semáforo leído, y Zoho, el cuadro de negocio y el KPI diciendo lo mismo.',
      pasos: [
        'Recibe del Administrador el formato SOLICITUD DE CONTRATO, tras la segunda entrevista.',
        'Confecciona el primer contrato: tres meses con un mes de prueba.',
        'Confecciona la renovación: un año con tres meses de prueba, con la segunda evaluación del Administrador.',
        'Busca las dos firmas, sella en el Ministerio de Trabajo e inscribe en la Caja de Seguro Social.',
        'Recibe cada permiso ya autorizado el mismo día, archívalo en el file y elévalo a la Junta por correo.',
        'Recibe de inmediato el aviso de todo arreglo de pago, con su evidencia.',
        'Verifica en el Drive que la ficha de la cuenta incobrable esté cargada.',
        'En el tramo de 46 a 61 días, pasa la lista de morosos al personal de cobro.',
        'Sostén la reunión semanal de cada centro y cierra los acuerdos con nombre y fecha.',
        'Al cierre del mes, concilia Zoho, el cuadro de negocio y el KPI centro por centro.',
        'Reporta a la Junta la cobertura de entrenamiento por centro, contada con firmas.',
      ],
      decide: [
        { situacion: 'A quién se contrata y si pasó el período de prueba', regla: 'La Junta escoge en la segunda entrevista; el Administrador evalúa. Tú confeccionas y tramitas: no eliges.' },
        { situacion: 'Un permiso, un descuento o un arreglo de pago', regla: 'Los autoriza el Administrador de Centro, y solo con su firma. Tú los recibes ya autorizados, los archivas y los elevas.' },
        { situacion: 'Un número que no cuadra', regla: 'Nadie lo fuerza: es falta grave. Buscas la diferencia y la reportas escrita.' },
      ],
      errores: [
        'Decidir por el centro porque ves todos los centros: dentro de un centro decide su Administrador.',
        'Esperar el insumo en silencio: sin SOLICITUD DE CONTRATO la persona empieza a trabajar sin contrato.',
        'Mirar solo el rojo: la alarma de este puesto es el centro en 88 por ciento que decrece.',
      ],
    },
