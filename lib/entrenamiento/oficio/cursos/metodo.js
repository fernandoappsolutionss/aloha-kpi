// Bloque A — Cómo se estudia esto (metodología HCA). Lo ven los dos roles.
...
export const METODO = [
  // minimoAprobacion(7) = 6 de 7. No se escribe: lo calcula el motor.
  {
    ...
    titulo: 'Cómo se estudia esto: tu hat y las tres barreras',
    duracionMin: 12,
    requiere: [],
    fuente: [
    ...
    pfv: 'Puedes decir el producto final valioso de tu puesto en una sola frase, sin leerla.',
    voz: 'Este módulo va primero en todos los cursos. <break time="0.3s"/> Se estudia una vez y se aplica siempre. <break time="0.5s"/> No es una introducción de cortesía. <break time="0.3s"/> Es lo que decide si el resto te sirve, o se te olvida en dos semanas. <break time="0.4s"/> Aquí no se estudia para saber. Se estudia para HACER. <break time="0.5s"/> Si al terminar no puedes ejecutarlo delante de tu jefe inmediato, <break time="0.3s"/> no lo aprendiste. Aunque hayas leído todo. <break time="0.4s"/> Y tu hat no es una lista de tareas. Es una cosa que produces. <break time="0.5s"/> El examen más corto de todos es este: <break time="0.3s"/> decir tu producto final valioso en una sola frase, sin leerla. <break time="0.4s"/> Si todavía no te sale, da igual cuántos módulos lleves.',
    masa: [
      ...
      'Papel y lápiz, para escribir tu producto final valioso en una sola frase y guardarlo.',
    ],
    palabras: [
      'hat',
    ...
    bloques: [
      {
        t: 'p',
        texto: 'Este módulo va primero en todos los cursos de ALOHA. Se estudia una vez y se aplica siempre, en cada módulo que abras de aquí en adelante.',
      },
      {
        t: 'p',
        texto: 'No es relleno ni introducción de cortesía. Es la parte que decide si el resto del entrenamiento te sirve o se te olvida en dos semanas. En ALOHA entrenamos con la **metodología HCA**, y esa metodología tiene una posición clara: el entrenamiento no es transmitir teoría de moda ni hacerte memorizar. El objetivo es **comprensión real y capacidad práctica de aplicación en tu puesto de trabajo**.',
      },
      {
        t: 'nota',
        tono: 'regla',
      ...
      { t: 'sub', texto: 'Qué te llevas de este módulo y de los dos que siguen' },
      {
        t: 'lista',
        items: [
          'Qué es tu **hat** (tu puesto) y cuál es el producto que se espera de ti.',
          ...
          'La regla del **gradiente**: qué hacer cuando te atascas.',
          'La regla de la **masa**: qué tienes que tener delante antes de abrir cualquier módulo.',
          'Cómo se aprueba de verdad: el **drill**.',
      ...
      {
        t: 'p',
        texto: 'El entrenamiento HCA se divide en dos vertientes que caminan juntas.',
      },
      {
        t: 'tabla',
        ...
        filas: [
          [
            '**Entrenamiento en el puesto (hatting)**',
      ...
      { t: 'sub', texto: 'Esto no es una charla: es tu hat' },
      {
        t: 'p',
        texto: 'Hat en inglés es "sombrero". En la metodología es el nombre de tu puesto y de todo lo que viene con él. Tu hat son tres cosas, y nada más.',
      },
      {
        t: 'lista',
        items: [
          ...
          '**Tu producto final valioso:** la cosa concreta, contable y de calidad que tu puesto le entrega al Centro.',
        ],
      },
      {
        t: 'p',
        texto: 'Un video que se ve una vez no te pone el sombrero. Una charla tampoco. El hatting es un entrenamiento formal, con un antes y un después: antes no podías ejecutar tu puesto sola, después sí.',
      },
      { t: 'sub', texto: 'Por qué importa tanto' },
      {
        t: 'p',
        texto: 'Cuando una persona está entrenada de verdad en su hat pasan dos cosas que se notan de inmediato en el Centro: **se corrige sola** —detecta su error rápido y lo arregla sin que nadie tenga que descubrirlo por ella— y **empuja por iniciativa propia**, porque sabe exactamente hacia dónde va. Un Centro con la gente hatted es un Centro estable. Un Centro donde cada quien improvisa su cargo vive apagando incendios.',
      },
      { t: 'sub', texto: 'Tu producto final valioso' },
      {
        t: 'p',
        texto: 'Este es el cierre de todo hat. No es una descripción bonita del cargo: es lo que se cuenta a fin de mes.',
      },
      {
        t: 'tabla',
        encabezados: ['Hat', 'Producto final valioso', 'Cómo se mide en el Manual'],
        filas: [
          [
      ...
      },
      {
        ...
        tono: 'ojo',
        titulo: 'Ojo con esto',
        texto: 'Si no puedes decir tu producto final valioso en una sola frase, sin pensarlo mucho, todavía no estás hatted. No importa cuántos módulos hayas leído. Ese es el examen más corto de todos.',
      },
      ...
      },
      {
        ...
        filas: [
          [
            '**1. Ausencia de masa.** Estudias algo sin tener delante la cosa real',
          ...
          [
            '**2. Gradiente excesivo.** Diste un salto sin dominar el paso anterior',
          ...
          [
            '**3. Palabra malentendida.** Pasaste por una palabra cuyo significado no comprendes del todo',
            'Mente en blanco, lees sin registrar, aburrimiento, ganas de abandonar el curso',
    ...
    quiz: [
      {
        pregunta: 'Tu hat son tres cosas. ¿Cuáles?',
        opciones: [
          'Tu horario, tu sueldo y tu jefe',
          'Tu contrato, tu uniforme y tu escritorio',
          'Tus responsabilidades, tus tareas y tu producto final valioso',
          'Tus metas, tus permisos y tus vacaciones',
        ],
        explicacion: 'El hat es el puesto completo: de qué respondes, qué haces y qué entregas.',
        repasa: ['hat'],
      },
      {
        pregunta: 'El producto final valioso del Administrador de Centro es…',
        opciones: [
          'Un Centro limpio y en orden para poder dar clase',
          'Niños que dominan la técnica y aprueban su nivel',
        ...
        explicacion: 'Los otros tres son productos reales, pero de otros hats: aseo, Coach y Asistente Administrativo.',
        repasa: ['producto-final-valioso'],
      },
      {
        pregunta: 'El producto final valioso del Asistente Administrativo se mide en el Manual con…',
        opciones: [
      ...
      },
      {
        ...
        opciones: [
          'Gradiente excesivo: te devuelves al principio del curso',
          'Ausencia de masa: consigues el objeto real que el módulo describe y lo pones delante',
          'Palabra malentendida: buscas la palabra en el diccionario',
          'Ninguna: descansas y sigues mañana',
        ],
        explicacion: 'La ausencia de masa es la única barrera con síntomas físicos claros. Por eso se reconoce por el cuerpo.',
        repasa: ['masa'],
      },
      {
      ...
      {
        pregunta: 'Cuando una persona está entrenada de verdad en su hat, se corrige sola y empuja por iniciativa propia.',
        opciones: ['Verdadero', 'Falso'],
        explicacion: 'Son las dos cosas que se notan de inmediato en el Centro. Un Centro donde cada quien improvisa su cargo vive apagando incendios.',
      },
      {
        pregunta: 'Ver una vez el video de tu puesto ya cuenta como hatting.',
        opciones: ['Verdadero', 'Falso'],
        explicacion: 'Un video que se ve una vez no te pone el sombrero, y una charla tampoco. El hatting es un entrenamiento formal: antes no podías ejecutar tu puesto sola, después sí.',
        repasa: ['hat'],
      },
    ],
    drills: [],
  ...
  // minimoAprobacion(7) = 6 de 7. No se escribe: lo calcula el motor.
  {
    ...
    orden: 2,
    roles: ['administradora', 'asistente'],
    titulo: 'La palabra malentendida y cómo se aclara, paso a paso',
    duracionMin: 15,
    requiere: ['of-met-1'],
    ...
    quiz: [
      {
        ...
        opciones: [
          ...
          'Tu mente queda en blanco justo después de esa palabra y de ahí en adelante dejas de registrar',
  ...
  // minimoAprobacion(10) = 8 de 10. No se escribe: lo calcula el motor.
  {
    ...
    orden: 3,
    roles: ['administradora', 'asistente'],
    titulo: 'Masa, gradiente y el drill: cómo se aprueba de verdad',
    duracionMin: 25,
    requiere: ['of-met-2'],
    fuente: [
    ...
    pfv: 'Preparas la masa antes de abrir cualquier módulo, te devuelves cuando te atascas y cierras cada módulo con su drill hecho hasta que sale bien.',
    voz: 'Masa es la cosa real de la que habla lo que estás estudiando. <break time="0.4s"/> El formato que vas a llenar. La pantalla que vas a usar. <break time="0.5s"/> Estudiar sin masa es aprender a manejar leyendo un manual en la sala. <break time="0.3s"/> Sin carro. <break time="0.5s"/> Si abriste un módulo y no tienes delante lo que describe, para. <break time="0.3s"/> Consíguelo primero. <break time="0.4s"/> El gradiente es lo otro. Si te atascas, el problema no está donde te atascaste. <break time="0.3s"/> Está antes. Devuélvete. <break time="0.5s"/> Y todo módulo cierra con su drill. <break time="0.3s"/> Ese no lo apruebas respondiendo. Lo apruebas haciéndolo, delante de tu Oficial de Entrenamiento. <break time="0.4s"/> Y lo firma él. Tú no.',
    masa: [
      'El sistema y los formatos reales de tu Centro a la mano: es sobre ellos que se hace todo drill.',
      'Tu jefe inmediato avisado de que vas a pedirle el primer drill esta semana.',
      'Papel y lápiz para escribir las tres palabras aclaradas y tu producto final valioso.',
    ],
    palabras: [
      'masa',
      'gradiente',
    ...
    bloques: [
      { t: 'sub', texto: 'Barrera 1 — Ausencia de masa: qué es' },
      {
        t: 'p',
        texto: '**Masa** es la cosa real de la que habla lo que estás estudiando: el objeto físico, el sistema, el documento, el lugar. Ausencia de masa es estudiar el concepto sin tener nada de eso delante. Puras palabras en el aire.',
      },
      {
        t: 'p',
      ...
      },
      {
        t: 'nota',
        tono: 'alerta',
        titulo: 'No arranques sin la masa',
        texto: 'Si abriste un módulo y no tienes delante lo que ese módulo describe, para. Consíguelo primero. Estudiar sin masa no es "avanzar aunque sea algo": es gastar el tiempo y quedarte con la sensación de que ya lo viste, que es peor que no haberlo leído.',
      },
      { t: 'sub', texto: 'Los tipos de masa que usamos aquí' },
      {
        t: 'tabla',
        encabezados: ['Tipo de masa', 'Qué es en concreto'],
        filas: [
          [
      ...
      },
      {
        ...
        texto: 'Marcar un módulo como visto sin haber tenido la masa delante. Queda registrado como avance, tu jefe cree que ya lo sabes, te sueltan el área y el error aparece con dinero de por medio. Si no tuviste la masa, no lo marques. Consecuencia: la casilla se anula y el paso se repite. No lo confundas con una falta grave, que en el Manual es otra cosa y es causal de despido inmediato: alterar edades, falsificar informes, emitir constancias sin autorización. Un módulo mal marcado se corrige; eso no.',
      },
      { t: 'sub', texto: 'Barrera 2 — Gradiente excesivo: qué es' },
      {
        t: 'p',
        texto: '**Gradiente** es la pendiente: de lo fácil a lo difícil, un paso a la vez. Gradiente excesivo es el salto demasiado brusco: intentar una acción difícil sin haber dominado el paso anterior que era indispensable.',
      },
      { t: 'sub', texto: 'Cómo se siente' },
      {
        t: 'lista',
      ...
      },
      {
        ...
        texto: 'Cuando te atascas, la dificultad real no está en el paso donde te atascaste. Está en un paso anterior que no quedó asimilado del todo. Por eso repetir el paso actual más fuerte, o más veces, no lo arregla: estás martillando en el lugar equivocado.',
      },
      ...
      {
        t: 'p',
        texto: 'ALOHA aplica esta misma regla con los niños, y por eso el Manual lo tiene escrito: un grupo abre con **mínimo 10 niños** (Tiny Tots puede abrir con **8**); en el itinerario Tiny Tots se pueden incorporar niños nuevos **hasta la semana 4**, y en KIDS **únicamente hasta la semana 2 del libro**. Y un niño graduado de Tiny Tots que pasa a Kids **ingresa en el nivel 5**, no en el 1. Nada de eso es capricho: es gradiente. Al niño no se le monta encima un paso que no puede dar. A ti tampoco.',
      },
      {
        t: 'sub',
        texto: 'La regla del gradiente: si te atascas, el problema está antes',
      },
      {
        t: 'p',
        texto: 'El orden de los módulos de tu curso no es un índice: es un **gradiente estricto**. Cada módulo usa solamente lo que ya dominaste en los anteriores, y nada más. Está armado así a propósito. Por eso, cuando algo se pone imposible, la respuesta no es empujar más duro. Es devolverse.',
      },
      {
        t: 'pasos',
        items: [
          ...
          'Arregla eso: aclara la palabra, o haz el paso con la masa delante.',
      ...
      { t: 'sub', texto: 'Cómo se aprueba: el drill' },
      {
        t: 'p',
      ...
      {
        t: 'p',
        texto: '**Para qué sirve el cuestionario entonces.** Tiene un solo trabajo útil: detectar palabras malentendidas. Cada pregunta que fallas te está señalando dónde quedó un hueco. No es la nota lo que importa: es el mapa de lo que tienes que devolverte a aclarar. Una nota alta con procedimientos que no sabes ejecutar no vale nada en un Centro.',
      },
      {
        t: 'p',
        texto: '**Qué es un drill.** Un drill es hacerlo de verdad. No contar cómo se hace: hacerlo. Cada bloque de cada curso cierra con uno.',
      },
      {
        t: 'tabla',
        encabezados: ['Eso no es un drill', 'Eso sí es un drill'],
        filas: [
          [
      ...
      { t: 'sub', texto: 'Cómo se hace un drill bien' },
      {
        t: 'pasos',
        items: [
          ...
          'Completo, de principio a fin, incluido el cierre del procedimiento.',
          'Si sale mal: se identifica **qué** falló, se corrige, y **se repite completo**.',
      ...
      },
      {
        ...
        tono: 'regla',
        titulo: 'Regla clave',
        texto: 'El drill se hace hasta que sale bien, no hasta que se responde una vez. Y "sale bien" quiere decir que lo hiciste sola, completo y sin dudar. Si dudaste en un paso, ese paso tiene una palabra o un hueco atrás.',
      },
      {
        t: 'p',
      ...
      { t: 'sub', texto: 'Tu jefe inmediato es tu oficial de entrenamiento' },
      {
        t: 'p',
        texto: 'En esta metodología el ejecutivo no es solo el que manda: es el **oficial de entrenamiento** de su gente. Designa las tareas y se asegura de que la capacitación de cada persona se lleve a cabo de manera competente.',
      },
      {
        t: 'nota',
        tono: 'regla',
      ...
      {
        t: 'p',
        texto: 'Son nueve y las vas a ver en todo el entrenamiento. Aclara estas nueve antes de abrir tu hat: son las únicas que hacen falta para entender el entrenamiento mismo. Las palabras del negocio se aclaran después, en cada drill, con su masa delante.',
      },
      {
        t: 'tabla',
        ...
        filas: [
          [
            '**Hat** (puesto)',
            'Tu puesto y todo lo que trae: responsabilidades, tareas y el producto que entrega.',
          ],
          [
          ...
          [
            ...
            'El orden de dificultad, donde cada paso se apoya en el anterior ya dominado.',
          ],
          [
            '**Palabra malentendida** (palabra sin aclarar)',
            'Una palabra cuyo significado no comprendiste del todo. Después de ella la mente queda en blanco.',
          ],
          [
          ...
          [
            '**Drill** (práctica)',
            'Hacer la acción de verdad, con un caso real y la masa delante. No es un quiz: se aprueba haciéndolo.',
          ],
          [
            '**Checksheet** (hoja de pasos)',
      ...
      },
      {
        ...
        encabezados: ['Si eres...', 'Tu jefe inmediato, tu oficial de entrenamiento'],
        filas: [
      ...
      { t: 'sub', texto: 'Qué te toca a ti en esa relación' },
      {
        ...
        items: [
          ...
          'Pedir el drill. No esperar a que te lo pidan.',
          'Pedir la masa cuando no la tienes: el acceso al sistema, el formato, el archivo.',
        ],
      },
      {
        t: 'nota',
      ...
      { t: 'sub', texto: 'Tu arranque: la lista antes del primer módulo de tu curso' },
      {
        ...
        filas: [
          ...
          [
            '2',
            'Consigo la **masa**: el sistema abierto, el formato en la mano, el documento en pantalla.',
          ],
          [
            '3',
          ...
          [
            '5',
            'Cierro el módulo con su **drill**, hecho hasta que sale bien, y lo demuestro ante mi jefe inmediato.',
          ],
        ],
      },
      ...
      },
      {
        ...
        items: [
          ...
          '¿Cuál es **mi producto final valioso** y en qué contribuyó lo que acabo de aprender?',
        ],
      },
      {
        t: 'nota',
        ...
        texto: 'Un entrenamiento no se aprueba leyendo. Se aprueba haciendo. Y quien puede hacer su puesto completo, se corrige sola, empuja por su cuenta y sostiene el Centro. Ese es el objetivo de todo lo que sigue.',
      },
    ],
    quiz: [
      {
        ...
        opciones: [
          'Paras y consigues la masa primero: sin ella el módulo son palabras en el aire',
          'Avanzas igual, algo se queda',
          'Lo lees y lo repasas mañana con la masa',
          'Lo marcas como visto y lo practicas después',
        ],
        explicacion: 'Estudiar sin masa no es "avanzar aunque sea algo": es gastar el tiempo y quedarte con la sensación de que ya lo viste, que es peor que no haberlo leído.',
        repasa: ['masa'],
      },
      {
        pregunta: 'Te atascas en la nómina de Coaches. Según la regla del gradiente, ¿dónde está la dificultad real?',
        opciones: [
      ...
      {
        pregunta: '¿Cuál de estas cuatro cosas es un drill?',
        opciones: [
          'Explicar qué es una factura recurrente',
          'Decir cuáles son los tramos de vencimiento',
          'Crear una factura recurrente en el sistema y detenerla, con alguien mirándote',
        ...
        explicacion: 'Un drill es hacerlo de verdad, no contar cómo se hace.',
        repasa: ['drill'],
      },
      {
        pregunta: 'Un drill se repite hasta que…',
        opciones: [
          'Se hizo una vez de principio a fin',
          'Lo apruebe el cuestionario',
          'Se acabe el tiempo asignado al módulo',
          'Sale bien: sola, completo y sin dudar',
        ],
        explicacion: 'Si dudaste en un paso, ese paso tiene una palabra o un hueco atrás.',
        repasa: ['drill'],
      },
      {
        pregunta: '¿Para qué sirve el cuestionario en esta metodología?',
        opciones: [
          'Para detectar palabras malentendidas: cada pregunta fallada señala dónde quedó un hueco',
          'Para poner la nota que decide si apruebas el módulo',
          'Para sustituir el drill cuando no hay tiempo',
      ...
      {
        pregunta: 'Marcar un módulo como visto sin haber tenido la masa delante es una falta grave y causal de despido inmediato.',
        opciones: ['Verdadero', 'Falso'],
      ...
      {
        pregunta: 'El orden de los módulos de tu curso es un gradiente estricto: cada módulo usa solamente lo que ya dominaste en los anteriores.',
        opciones: ['Verdadero', 'Falso'],
    ...
    drills: [
      {
        titulo: 'Drill de arranque — Aclarar tres palabras y decir tu producto final valioso sin leer',
        fuente: '00-como-se-estudia.html#hca11',
        proposito: 'Que sepas aclarar una palabra tú sola con los ocho pasos, y que puedas decir el producto final valioso de tu puesto en una sola frase, sin leerla.',
        gradiente: 'Exige los módulos 1 y 2 del método estudiados. Si todavía no puedes explicar qué es una palabra malentendida, vuelve al módulo anterior antes de intentar este drill.',
        masa: [
          'Un diccionario común, en papel o en el teléfono.',
        ...
        pasos: [
          ...
          'Escribe **tu producto final valioso** en una sola frase, sin copiarla de la tabla.',
        ...
        criterios: [
          ...
          'Dice su producto final valioso en una sola frase, con sus palabras, sin copiarlo de la tabla.',
