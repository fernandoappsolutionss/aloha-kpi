// Bloque A — Cómo se estudia a bordo. Lo ven los dos roles.
...
//
//   hat                          → tu puesto           (largo: tu puesto a bordo, solo al presentarlo en of-met-1)
...
//   el nombre del método          → el Entrenamiento a Bordo  (en prosa: "aquí se entrena a bordo")
//   Tecnología de Estudio        → cómo se estudia a bordo
//
//   Las tres barreras:
//     1 · ausencia de masa       → estudiar a ciegas
//     2 · gradiente excesivo     → entrar antes de tiempo
//     3 · palabra malentendida   → palabra sin aclarar
//     el estado de la barrera 3  → quedarse en blanco
//
//   LAS LETRAS O·L·A NO VAN EN EL TEXTO VISIBLE, y no es olvido. La empresa ya
//   evalúa a esta persona sobre OTRO acrónimo con las mismas letras: los
//   valores ALOHA (A de Amor, L de Lograr, O de Objetivos, H de Honestidad, A
//   de Autocontrol), que of-nor-1 enseña y examina —"en los valores ALOHA, la
//   letra O corresponde a…"—. Rotular las barreras con O y A le monta un
//   segundo alfabeto encima del que sí le califican, dentro del módulo que
//   enseña que un símbolo sin aclarar te deja en blanco. Además la L (Liderar)
//   no tendría dónde aterrizar. El esqueleto O·L·A vive donde debe: en el
//   ORDEN de los tres módulos —of-met-1 observar, of-met-2 observar, of-met-3
//   avanzar y liderar— y en la estructura, no en la decoración.
//
...
//     of-met-1 → "Antes de remar, mirar."            (las tres barreras)
//     of-met-2 → ninguna
...
//   Bordo", "a bordo", "cómo se estudia a bordo") y el nombre no es una imagen.
//
...
export const METODO = [
  // minimoAprobacion(7) = 6 de 7. No se escribe: lo calcula el motor.
  {
    ...
    titulo: 'Cómo se estudia a bordo: tu puesto y las tres barreras',
    duracionMin: 12,
    requiere: [],
    fuente: [
    ...
    bloques: [
      {
        t: 'p',
        texto: 'Entrenamiento a Bordo · ALOHA. Este módulo va primero en todos los cursos. Se estudia una vez y se aplica siempre, en cada módulo que abras de aquí en adelante. Aquí nadie viaja de pasajero.',
      },
      {
        t: 'p',
      ...
      { t: 'sub', texto: 'Qué te llevas de este módulo y de los dos que siguen' },
      {
        ...
        items: [
          ...
          'La regla del **orden de los pasos**: qué hacer cuando te atascas.',
      ...
      {
        t: 'p',
        texto: 'Tu puesto a bordo es tu cargo y todo lo que viene con él. Son tres cosas, y nada más.',
      },
      {
        t: 'lista',
        items: [
      ...
      {
        t: 'p',
        texto: 'Cuando una persona tiene su puesto tomado de verdad pasan dos cosas que se notan de inmediato en el Centro: **se corrige sola** —detecta su error rápido y lo arregla sin que nadie tenga que descubrirlo por ella— y **empuja por iniciativa propia**, porque sabe exactamente hacia dónde va.',
      },
      {
        t: 'p',
        texto: 'Un Centro con la gente en su puesto es un Centro estable. Un Centro donde cada quien improvisa su cargo vive en **caos disfrazado**: fuegos que no terminan.',
      },
      ...
      {
        t: 'p',
        texto: 'Las tres se arreglan de dos maneras, y nada más: mirar antes de moverte, o dar el paso que toca en vez del que viene después. Antes de remar, mirar.',
      },
      {
        t: 'tabla',
        ...
        filas: [
          [
            '**1 · Estudiar a ciegas.** Estudias algo sin tener delante la cosa real',
          ...
          [
            '**2 · Entrar antes de tiempo.** Diste un salto sin dominar el paso anterior',
          ...
          [
            '**3 · Palabra sin aclarar.** Pasaste por una palabra cuyo significado no comprendes del todo',
  ...
  // minimoAprobacion(7) = 6 de 7. No se escribe: lo calcula el motor.
  {
    ...
    bloques: [
      {
        t: 'p',
        texto: 'Esta es la **palabra sin aclarar**: la barrera principal, y la razón número uno por la que la gente abandona un entrenamiento, se aburre o concluye que "no es para ella". Merece su propio módulo porque es la que más daño hace y la que menos se detecta sola.',
      },
      {
        t: 'p',
        texto: 'Es la barrera 3, y se resuelve mirando hacia atrás, no empujando hacia adelante.',
      },
  ...
  // minimoAprobacion(10) = 8 de 10. No se escribe: lo calcula el motor.
  {
    ...
    bloques: [
      ...
      {
        t: 'p',
        texto: '**El orden de los pasos** es eso: de lo fácil a lo difícil, un paso a la vez, y cada paso apoyado en el que ya dominaste. Entrar antes de tiempo es el salto demasiado brusco: intentar una acción difícil sin haber dominado el paso anterior que era indispensable.',
      },
      { t: 'sub', texto: 'Cómo se siente' },
      {
        t: 'lista',
    ...
    drills: [
      {
        titulo: 'Maniobra 1 — Aclarar tres palabras y decir tu producto sin leer',
