...
export const HAT_ADM = [
  {
    ...
    bloques: [
      { t: 'sub', texto: 'Tu producto, en una sola frase' },
      {
        t: 'p',
      ...
      },
      {
        ...
        texto: 'El manual nombra las activaciones como función tuya y nunca las define: falta qué cuenta como activación, cuántas al mes y con qué presupuesto. Y el cuadro de retiros se envía a un segundo correo, vcampos@panama.com, cuyo dominio no corresponde a ninguna otra dirección de la organización y parece error de transcripción. Ninguna de las dos se resuelve por cuenta propia: el paso se ejecuta y se firma con la nota del pendiente al lado, y tu jefe entrenador las lleva a la Junta.',
      },
    ],
    drills: [
      {
