// Paquete del puesto de Administrador de Centro (bloque A, orden 13).
...
export const HAT_ADM = [
  {
    ...
    titulo: 'Tu puesto: Administradora del Centro',
    duracionMin: 20,
    requiere: ['of-nor-9'],
    fuente: [
    ...
    voz: 'Antes de una sola tarea, esto. <break time="0.4s"/> Tu puesto no es una lista de cosas que haces. Es una cosa que produces. <break time="0.5s"/> Si al final del mes esa cosa no existe, <break time="0.3s"/> da igual cuántas horas estuviste en el Centro. <break time="0.4s"/> ¿Y cuál es la tuya? Míralo por donde te pagan la prima. <break time="0.5s"/> Niños que entran. Niños que no se van. Niños acumulados al cierre. <break time="0.4s"/> Eso es matrícula activa creciente, y ese es tu producto. <break time="0.5s"/> Una advertencia con el FODA. <break time="0.3s"/> El FODA no es tu producto. Es la evidencia de tu producto. <break time="0.4s"/> Un informe impecable con la matrícula cayendo es un buen reporte de un mal mes. <break time="0.3s"/> Y un mes bueno sin FODA entregado tampoco cuenta.',
    masa: [
    ...
    bloques: [
      { t: 'sub', texto: 'El producto de tu puesto, en una sola frase' },
      {
        t: 'p',
        texto: 'Antes de una sola tarea, esto: **un puesto no es una lista de cosas que haces. Es una cosa que produces.** Si al final del mes esa cosa no existe, no importa cuántas horas estuviste en el Centro.',
      },
      {
        t: 'nota',
        tono: 'regla',
        titulo: 'El producto del puesto de Administrador de Centro',
      ...
      {
        t: 'p',
        texto: 'Esto es tan importante como lo anterior. Un puesto mal delimitado hace que se pise el puesto ajeno: dos personas haciendo lo mismo, o una persona firmando lo que no le toca. Y en varios de estos casos, hacerlo es falta grave.',
      },
      {
        t: 'tabla',
      ...
      },
      {
        ...
        texto: 'El manual nombra las activaciones como función tuya y nunca las define: falta qué cuenta como activación, cuántas al mes y con qué presupuesto. Y el cuadro de retiros se envía a un segundo correo, vcampos@panama.com, cuyo dominio no corresponde a ninguna otra dirección de la organización y parece error de transcripción. Ninguna de las dos se resuelve por cuenta propia: el paso se ejecuta y se firma con la nota del pendiente al lado, y tu jefe, en su papel de entrenador, las lleva a la Junta.',
      },
    ],
    drills: [
      {
        titulo: 'Maniobra 1 — Nombrar tu puesto y tu producto',
        ...
        gradiente: 'Es la primera maniobra del puesto. No hay paso previo. Si aquí se traba, el problema es de palabras, no de puesto: aclara el producto de tu puesto e indicador antes de seguir.',
        masa: [
        ...
        pasos: [
          ...
          'Escribe en una hoja, en una sola frase, el producto de tu puesto: la cosa concreta, contable y de calidad que entregas.',
        ...
        criterios: [
          'Dice el producto de su puesto de memoria, en una sola frase, dos días distintos.',
        ...
        errorTipico: 'Contesta con una lista de tareas —superviso, organizo, atiendo padres— en vez de un producto. Una lista de tareas no es un producto: el producto es lo que queda entregado cuando las tareas se hicieron bien. Mientras conteste tareas, no tiene su puesto tomado.',
      },
    ],
    quiz: [
      {
        pregunta: '¿Cuál es el producto del puesto de Administrador de Centro?',
        opciones: [
      ...
      {
        pregunta: 'El informe FODA es el producto del puesto de Administrador de Centro.',
