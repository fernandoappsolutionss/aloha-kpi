...
export const NORMATIVA = [
  // minimoAprobacion(10) = 8 de 10. No se escribe: lo calcula el motor.
  {
    ...
    palabras: [
      ...
      // Programa (2 niveles por ciclo, según el Manual); 'ciclo-de-matricula'
      // es el paquete/artículo que el padre pagó (Manual + Zoho). Las dos
      // tarjetas tienen que estar arriba: es la confusión que el padre trae a
      // la recepción.
      'ciclo',
      'ciclo-de-matricula',
      'nivel',
    ...
    laminas: [
      ...
      // etapa pedagógica del Programa y el paquete que se cobra (Manual y Zoho).
      {
        kicker: 'Ciclos del Programa',
        titulo: 'Cada ciclo tiene dos niveles',
        items: [
          'Cada Ciclo está comprendido por 2 niveles.',
          '1er Ciclo del Programa o Ciclo Básico: niveles 1 y 2, donde se terminan las 34 fórmulas.',
          'Programa Básico: 2 ciclos, es decir, 4 niveles.',
          'Programa PRO: 2 ciclos en Kids y 3 ciclos en Tiny Tots.',
          'Kinder Tiny Tots: niños de 3 a 4 años, como preparación para Tiny Tots.',
        ],
        cierre: 'Esta es la terminología vigente del Manual revisado en octubre de 2025.',
      },
      {
        kicker: 'Ciclo de matrícula',
        titulo: 'Y el artículo facturado se lee completo',
        items: [
          'El Manual define el ciclo pedagógico; Zoho contiene artículos operativos de matrícula.',
          'Antes de facturar, lee itinerario, centro y cantidad de niveles en el nombre del artículo.',
          'Si el artículo dice 1, 2 o 3 niveles, factura lo contratado; no lo cambies de memoria.',
          'Un nivel dura 19 a 22 semanas, unos 5 meses según calendario.',
        ],
        cierre: 'El calendario del grupo se arma por bloques de dos niveles, pero la factura sigue el artículo vendido.',
      },
      {
        kicker: 'Tu cargo',
    ...
    sop: {
      ...
      producto: 'La misma respuesta institucional en cualquier Centro, dicha sin leer, y los ciclos del Programa separados del artículo de matrícula cuando el padre los mezcla.',
      pasos: [
        ...
        'Si confronta el Manual con su factura, separa los dos sentidos antes de defender el precio: el ciclo del Programa describe aprendizaje y cada ciclo tiene 2 niveles; el artículo de matrícula dice cuántos niveles contrató ese padre.',
        'Y quítale el miedo: los niveles que compró se le dan completos y al terminarlos matricula el siguiente tramo. Nunca inventes una equivalencia ni desautorices un documento de la empresa delante del padre.',
      ],
      decide: [
    ...
    bloques: [
      ...
      // quien factura "1er ciclo Matrícula" y quien tiene que explicar qué
      // cubre un ciclo y qué cubre el artículo vendido. El manual completo
      // revisado OCT2025 reemplaza la decisión provisional del 2026-09-04:
      // cada ciclo del Programa son 2 niveles; el 1er ciclo o Ciclo Básico son
      // niveles 1 y 2; Básico completo son 2 ciclos/4 niveles; PRO son 2
      // ciclos en Kids y 3 en Tiny Tots.
      { t: 'sub', texto: 'Ciclos dentro del Programa' },
      {
        t: 'p',
        texto: 'Cuidado con esta palabra. En el Manual, **cada ciclo del Programa está comprendido por 2 niveles**. En Zoho, además, "1er ciclo Matrícula" aparece como nombre de artículos reales. Tienes que separar el ciclo pedagógico de la etiqueta de facturación, porque el padre te los va a mezclar de frente.',
      },
      {
        t: 'p',
        texto: 'El **1er Ciclo del Programa** es el **Ciclo Básico**: niveles 1 y 2, donde se terminan de ver las 34 fórmulas del Programa ALOHA. El **Programa Básico** completo comprende 2 ciclos, es decir, 4 niveles.',
      },
      {
        t: 'tabla',
        titulo: 'Ciclos dentro del Programa según el Manual',
        encabezados: ['Punto del Manual', 'Regla vigente'],
        filas: [
          ['Cada ciclo', '2 niveles'],
          ['1er Ciclo del Programa o Ciclo Básico', 'Niveles 1 y 2; allí se terminan las 34 fórmulas'],
          ['Programa Básico', '2 ciclos, es decir, 4 niveles'],
          ['Programa PRO Kids', '2 ciclos'],
          ['Programa PRO Tiny Tots', '3 ciclos'],
        ],
      },
      {
        t: 'p',
        texto: '**Kinder Tiny Tots** es para niños de **3 a 4 años**. Es un programa preescolar que prepara al alumno para Tiny Tots con tres herramientas clave: ábaco, inteligencias múltiples y matemáticas.',
      },
      {
        t: 'p',
        texto: 'La **matrícula** y el artículo de Zoho se leen aparte. El Manual da la regla pedagógica de ciclos y niveles; el catálogo conserva artículos de matrícula con su itinerario, centro y cantidad de niveles. Factura el artículo que el padre contrató y no cambies el número de niveles por memoria.',
      },
      {
        t: 'lista',
        items: [
          ...
          'El Manual usa una referencia económica: cada nivel vale **B/.600,00** y se divide en **5 mensualidades** para facilitar el financiamiento del padre.',
          'El calendario del grupo se arma en **bloques de dos niveles**, iguales para todo el grupo. Lo que varía padre por padre es el artículo y la cantidad de niveles efectivamente contratados en Zoho.',
      ...
      { t: 'sub', texto: 'Qué le dices al padre que mezcla manual y factura' },
      {
        t: 'p',
        texto: 'Te va a pasar: el padre leyó que cada ciclo tiene dos niveles y la factura dice "1er ciclo, 3 niveles". Antes de defender el precio, separa aprendizaje de facturación. Va en este orden:',
      },
      {
        t: 'pasos',
        items: [
          'Sepáralo antes de defender ningún precio: "Son dos cosas distintas, señora: el ciclo del Programa y el artículo que usted contrató."',
          'Primero el Programa: "Según el Manual, cada ciclo tiene dos niveles. El Ciclo Básico son los niveles 1 y 2, donde se completan las 34 fórmulas."',
          'Después la factura: "Este artículo indica cuántos niveles contrató usted en esta matrícula. Por eso lo leemos completo: itinerario, centro y cantidad de niveles."',
          'Y cierra el hueco antes de que lo abra ella: "Los niveles que usted contrató se le dan completos. Cuando los termine, matricula el siguiente tramo y sigue avanzando sin perder lo que pagó."',
      ...
      },
      {
        t: 'nota',
        tono: 'regla',
        titulo: 'No improvises equivalencias',
        texto: 'Nunca arregles una duda de ciclos cambiando el artículo facturado de memoria. El Manual define el Programa; Zoho refleja lo vendido. Si algo no cuadra, se revisa el contrato y el artículo antes de hablar con el padre.',
      },
    ...
    drills: [
      {
        titulo: 'Maniobra 1 — Separar Programa y matrícula',
        fuente: 'curso-3-normativa.html#m1',
        proposito: 'Que le separes a un padre el ciclo del Programa del artículo de matrícula que le facturaste, con la regla vigente del Manual y sin inventar equivalencias.',
        gradiente: 'Si todavía no distingue los dos sentidos leyéndolos, no le montes la escena: hazle leer en voz alta la tabla del Manual y decir qué cubre el Ciclo Básico, cuántos ciclos tiene Básico completo y cuántos ciclos tiene PRO en Kids y Tiny Tots.',
        masa: [
          'Una factura real de matrícula de tu Centro, donde se lea "1er ciclo" y el número de niveles.',
          'La tabla de Ciclos dentro del Programa impresa, boca abajo sobre la mesa.',
        ],
        pasos: [
          'Di en voz alta, sin mirar nada: cada ciclo tiene 2 niveles; Ciclo Básico es niveles 1 y 2; Básico completo son 2 ciclos; PRO tiene 2 ciclos en Kids y 3 en Tiny Tots; Kinder Tiny Tots es 3 a 4 años.',
          'Tu jefe entrenador hace de madre molesta: llega con la factura de 3 niveles en la mano y con que en el Manual leyó que cada ciclo tiene dos niveles. Pregunta: "¿me están cobrando algo que no corresponde?".',
          'Contéstale de pie, con la hoja boca abajo: separa ciclo del Programa y artículo facturado, y cierra diciéndole que los niveles contratados se entregan completos.',
          ...
          'Última vuelta: el jefe entrenador te empuja a cambiar el artículo por memoria. Sostén que se revisa contrato y artículo; no se improvisa.',
        ],
        criterios: [
          'Separa ciclo del Programa y artículo facturado antes de hablar de dinero, y lo hace de pie y sin leer la hoja.',
          'Dice la regla vigente completa: 2 niveles por ciclo; Ciclo Básico niveles 1 y 2; Básico 2 ciclos; PRO 2 ciclos Kids y 3 Tiny Tots; Kinder 3 a 4 años.',
          ...
          'No inventa equivalencias ni cambia el artículo por memoria, ni siquiera cuando el jefe entrenador la empuja a hacerlo.',
        ],
        errorTipico: 'Defender el precio antes de separar las dos palabras. Se delata porque arranca la respuesta con "es que la matrícula incluye" en vez de con "son dos cosas distintas", y el padre se va convencido de que le cobraron mal.',
      },
    ],
  },
