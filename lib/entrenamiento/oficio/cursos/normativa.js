...
export const NORMATIVA = [
  // minimoAprobacion(10) = 8 de 10. No se escribe: lo calcula el motor.
  {
    ...
    palabras: [
      ...
      'colaborador',
      // Entra con "Ciclos dentro del Programa": es la unidad con la que se
      // cobra y la que se confunde con `nivel` en la primera semana.
      'ciclo',
      'nivel',
    ],
    laminas: [
      ...
      // Copiada literal de of-cen-1: el punto "Ciclos dentro del Programa" del
      // índice del Manual tiene que estar en bloque A, que llevan los dos
      // puestos. Es el vocabulario con el que se cobra la matrícula.
      {
        kicker: 'Ciclos',
        titulo: 'Cómo está hecho un ciclo',
        items: [
          ...
          'Sin vacaciones dentro del ciclo; una semana al pasar al siguiente.',
        ],
    ...
    sop: {
      ...
      producto: 'La misma respuesta institucional en cualquier Centro: origen, valores, visión y misión, dichos sin leer.',
      pasos: [
    ...
    bloques: [
      ...
      // quien factura "Matrícula de primer ciclo" y quien tiene que explicarle
      // al padre el costo del primer ciclo completo (Manual, charla de padres).
      // Aquí va en bloque A, que llevan los dos puestos, en el mismo lugar del
      // índice del Manual: después del Dojo Kun y antes de Responsables. El
      // texto es literalmente el de of-cen-1: no se reescribe, y allá se queda
      // porque el calendario del Centro se arma sobre esta misma estructura.
      { t: 'sub', texto: 'Ciclos dentro del Programa' },
      {
        t: 'p',
        texto: 'Un **ciclo son dos niveles seguidos**, y es la unidad con la que se cobra: la matrícula cubre un ciclo completo. El nivel es un libro; el ciclo, dos.',
      },
      {
        t: 'lista',
        items: [
          ...
          'En **diciembre** las últimas dos semanas son vacaciones.',
          '**No se deja semana de vacaciones dentro de los dos niveles que forman un ciclo.** Al terminar el ciclo y pasar al siguiente, sí. Ejemplo: no hay vacaciones entre nivel 1 y 2; al terminar el 2 y pasar al 3, se deja una semana.',
        ],
      },
