...
export const NORMATIVA = [
  // minimoAprobacion(10) = 8 de 10. No se escribe: lo calcula el motor.
  {
    ...
    // (de 764 a más de 1.200 palabras), más dos láminas, una tabla y el drill.
    // La portada y el índice del hat prometen estos minutos y con ellos la
    ...
    // drill se cierra con solo aprobar el cuestionario. Su quiz son las 10
    ...
    // diciéndolo. Con el drill, of-nor-1 ya no queda completo sin la firma del
    // Oficial de Entrenamiento. El gradiente no se toca: abrir el módulo
    // siguiente solo exige el anterior ESTUDIADO, así que nadie se traba.
    drills: [
      {
        titulo: 'Drill 1 — Los tres números del padre',
        ...
        pasos: [
          ...
          'El Oficial hace de madre molesta: llega con la factura de 3 niveles en la mano y con que en la web leyó que el Ciclo 2 tiene seis niveles. Pregunta: "¿me están cobrando la mitad?".',
          ...
          'El Oficial repite la escena cambiando el itinerario del niño (Tiny Tots en vez de Kids) y el paquete (2 niveles en vez de 3).',
          'Última vuelta: el Oficial te empuja a decir que la web está desactualizada. Sostén que las dos fuentes dicen la verdad de cosas distintas.',
        ],
        criterios: [
          ...
          'Cierra explicando que los niveles contratados se dan completos y que después se matricula el siguiente tramo, sin que el Oficial se lo tenga que pedir.',
          'No dice en ningún momento que la web esté mal ni que la factura esté mal, ni siquiera cuando el Oficial la empuja a decirlo.',
        ],
