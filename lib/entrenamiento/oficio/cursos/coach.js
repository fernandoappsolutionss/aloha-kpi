...
export const COACH = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    laminas: [
      ...
      },
      {
        ...
        cierre: 'El Coach del niño no debe dar la Clase de Reforzamiento: otra voz explica lo mismo de otra manera.',
      },
      {
    ...
    sop: {
      ...
      decide: [
        ...
        { situacion: 'Quién da el reforzamiento', regla: 'Lo decide el Administrador por aptitudes y personalidad. El Coach del niño no debe darla; la reposición sí puede darla él.' },
    ...
    bloques: [
      ...
      { t: 'nota', tono: 'regla', titulo: 'Dos cosas que se olvidan', texto: 'La Clase de Reforzamiento la puede dar un Coach o el Administrador, y **el Coach del niño no debe darla**. La idea es que otra voz explique lo mismo de otra manera.' },
    ...
    quiz: [
      ...
      },
      {
        ...
        opciones: ['Verdadero', 'Falso'],
        explicacion: 'Aquí sí puedes darla tú. En el reforzamiento no.',
        repasa: ['clase-de-reposicion'],
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    bloques: [
      ...
      { t: 'p', texto: 'Este es el módulo donde tu producto se ve. Tu producto no es la fiesta del cierre: son **los niños que llegan al Cierre y se inscriben en el siguiente nivel**. El KPI del Centro lleva ese número por Coach, y conviene que sepas exactamente qué mide antes de que alguien te lo enseñe en una pantalla.' },
      {
        t: 'tabla',
