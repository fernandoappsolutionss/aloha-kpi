...
// V/F más redundante — el mismo hecho se exige en el criterio de la Maniobra 11 y en
...
// (training.alohavenezuela.com) en la clave del Entrenamiento en Cubierta y para el
// SOP de una hoja. Su contrato vive en lib/entrenamiento/oficio/catalogo.js y en
...
// ── VOCABULARIO: Entrenamiento en Cubierta ────────────────────────────────────
...
//   gradiente → el orden      · hat → puesto (largo: tu puesto en cubierta)
...
export const ZOHO = [
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 1 — Recorrer los cuatro caminos del dinero en Zoho',
        ...
        gradiente: 'Es la primera maniobra de tu puesto; no exige nada previo. Si te atascas aquí, la causa es una palabra sin aclarar: vuelve al glosario, no al sistema.',
        masa: [
          'Zoho Books abierto en pantalla, con tu usuario, en la organización de tu Centro.',
          'Una factura real de tu Centro, impresa o en pantalla.',
          'Una factura de servicio de un Coach del último pago.',
        ...
        pasos: [
          'Abre Zoho Books y toma las cuatro cosas que van a la vista; ponlas donde las veas mientras trabajas.',
          'Toma la factura real. Di en voz alta qué camino del dinero es y quién genera ese documento.',
          'Recorre el menú y escribe en una hoja la ruta exacta, tal como aparece en tu pantalla, de: Contactos · Artículos · Ventas → Facturas · Ventas → Cotizaciones · Ventas → Facturas recurrentes · Compras → Facturas de proveedor · Compras → Gastos · Informes.',
          ...
          'Sin mirar la hoja, abre las ocho rutas seguidas mientras el jefe entrenador cronometra.',
        ...
        criterios: [
          ...
          'Con cada una de esas cuatro cosas en la mano dice, sin dudar, qué documento de Zoho le corresponde y quién lo genera.',
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 2 — Verificar la organización antes de tocar cualquier documento',
        ...
        gradiente: 'Exige la Maniobra 1 aprobada. Si te confundes con qué es una organización frente a un Centro, vuelve al glosario y a la Maniobra 1: no es un problema de esta maniobra.',
        masa: [
          'Zoho Books abierto en pantalla con el selector de organización visible.',
        ...
        pasos: [
          ...
          'El jefe entrenador deja Zoho abierto en una organización que no es la tuya y te llama a "hacer una factura urgente". Detecta el cambio y corrígelo antes de crear nada.',
        ...
        errorTipico: 'Mirar la organización sin leerla: los ojos pasan por el nombre y la cabeza sigue en la tarea. Se delata porque cae en la trampa del paso 6 sin darse cuenta, y cuando el jefe entrenador le pregunta en qué organización está, tiene que volver a mirar.',
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    laminas: [
      ...
      },
      {
        ...
        items: [
          ...
          'Seguro de accidentes: por ciclo de matrícula, al inscribir o renovar.',
      ...
      },
      {
        ...
        items: [
          ...
          'Ábaco, lápiz ALOHA y los libros de los niveles que contrató.',
    ...
    // 'ciclo-de-matricula' entra en el lugar de 'kit': el tope por módulo es 12.
    // Este módulo dice "ciclo" cuatro veces —"1er ciclo Matrícula", "por ciclo",
    // "de dos niveles"— y no decía "kit" ni una vez, así que el auto-enlace del
    // glosario (que solo marca los slugs declarados) ofrecía una palabra que no
    // aparece y se saltaba la que sí, justo donde se factura la matrícula del
    // primer ciclo. Y aquí el sentido es SIEMPRE el comercial: "1er ciclo" es el
    // paquete que compró el padre, no el 1er Ciclo del Programa del Manual
    // (niveles 1 y 2, Ciclo Básico).
    // Por eso la tarjeta que se declara es 'ciclo-de-matricula' y no 'ciclo'.
    palabras: ['articulo', 'cuenta-de-ingresos', 'itinerario', 'ciclo-de-matricula', 'nivel', 'matricula', 'mensualidad', 'seguro-de-accidentes-opcion-1', 'seguro-de-accidentes-opcion-2', 'seguro-estudiantil', 'clase-de-campeonato', 'canje-de-articulo'],
    ...
    bloques: [
      ...
      { t: 'sub', texto: 'Familias de artículos que vas a usar' },
      {
        ...
        filas: [
          ['Matrícula / 1er ciclo', '"1er ciclo Matrícula [itinerario] [centro] [nº de niveles]". Ej.: 1er ciclo Matrícula Kinder Calle 50 2 niveles', 'Al inscribir. Según el contrato de servicios, la matrícula incluye seis cosas: Seguro Estudiantil, mochila ALOHA, suéter ALOHA, ábaco, lápiz ALOHA y los libros de nivel (dos en el contrato tipo; el artículo dice cuántos contrató). La mochila y el ábaco se entregan una sola vez en todo el programa.'],
          ['Mensualidad', 'Mensualidad del itinerario y centro que corresponda', 'Cada mes, por factura recurrente'],
          ['Seguro de accidentes', '"Afiliación Seguro de accidente opción 1 / opción 2 [centro]"', 'Por ciclo de matrícula, al inscribir o renovar'],
      ...
      {
        t: 'p',
        texto: 'Ojo con el nombre del artículo: ese "1er ciclo" es el **ciclo de matrícula**, el paquete que compró el padre, y trae 1, 2 o 3 niveles según lo que contrató. **No** lo confundas con el 1er Ciclo del Programa del Manual, que es el Ciclo Básico de niveles 1 y 2. Las matrículas siguientes del mismo niño se llaman 2do Ciclo, 3er Ciclo y así: cuentan matrículas, no etapas de aprendizaje. Factura el ciclo que contrató, con el itinerario correcto, y la mensualidad aparte.',
      },
    ...
    quiz: [
      ...
      {
        pregunta: 'En el artículo "1er ciclo Matrícula Kids Calle 50 3 niveles", ese "1er ciclo" significa…',
        opciones: [
          'el 1er Ciclo del Programa, o sea niveles 1 y 2',
          'que el niño va en su primer nivel',
          'la primera matrícula del niño: el paquete de 3 niveles que contrató',
          'el primer mes de clases',
        ],
        explicacion: 'Es el ciclo de matrícula, el paquete que compró el padre. El 1er Ciclo del Programa del Manual es el Ciclo Básico de niveles 1 y 2; el artículo facturado se lee por su cantidad de niveles.',
        repasa: ['ciclo-de-matricula', 'primer-ciclo'],
      },
    ],

    drills: [
      {
        titulo: 'Maniobra 3 — Escoger el artículo correcto del catálogo',
        ...
        gradiente: 'Exige la Maniobra 2 aprobada. Si te enredas con qué Centro factura tu organización, el problema está en la Maniobra 2, no aquí.',
        masa: [
          'Zoho Books abierto en Artículos, filtrado por el nombre de tu Centro.',
          'Una factura real de matrícula de tu Centro, con su artículo visible.',
          'Hoja y lápiz para tu chuleta de artículos.',
        ...
        pasos: [
          ...
          'El jefe entrenador te dicta cinco casos ("Kinder, mi Centro, 3 niveles"; "Kids, mi Centro, 2 niveles"; una clase de campeonato; una reposición de material; un seguro opción 2). Selecciona el artículo correcto de cada uno en pantalla, sin agregarlo a ningún documento.',
        ...
        criterios: [
          ...
          'Lee el nombre completo del artículo antes de escogerlo — el jefe entrenador lo ve leyendo, no adivinando por la primera coincidencia del buscador.',
        ...
        errorTipico: 'Tomar el primer artículo que aparece en el buscador porque "dice Kinder". Se delata cuando el jefe entrenador le dicta "3 niveles" y ella selecciona el de 2 sin notarlo: el nombre lo leyó a medias.',
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 4 — Crear el cliente representante sin duplicarlo',
        ...
        gradiente: 'Exige la Maniobra 2 aprobada. Si dudas de en qué organización estás creando el contacto, regresa a la Maniobra 2 antes de seguir.',
        masa: [
          'Zoho Books abierto en Contactos, en la organización de tu Centro.',
          'Una ficha o formulario de inscripción real con los datos de un representante.',
          'El teléfono del Centro, para verificar el correo con el padre si hace falta.',
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 5 — Cotizar en caliente y convertir la cotización en factura',
        ...
        gradiente: 'Exige las Maniobras 3 y 4 aprobadas. Si te trabas escogiendo el artículo, el problema es la Maniobra 3. Si te trabas creando el cliente, es la Maniobra 4. No se repite esta maniobra: se devuelve a la que falta.',
        masa: [
          'Zoho Books abierto en Ventas → Cotizaciones, en la organización de tu Centro.',
          'Tu chuleta de artículos de la Maniobra 3.',
          'La lista de inscritos a una clase de prueba (real o del último evento) y tu Excel de control.',
          'Un cronómetro o el reloj del Centro.',
        ],
        pasos: [
          ...
          'Repite con tres representantes más. El jefe entrenador cronometra las cuatro.',
          'El jefe entrenador te dice "la señora cerró". Abre esa cotización y usa Convertir a factura. No la vuelvas a escribir a mano.',
        ...
        criterios: [
          ...
          'Convierte a factura usando la función de Zoho, nunca reescribiendo — el jefe entrenador ve la factura enlazada a su cotización.',
      ...
      {
        titulo: 'Maniobra 5-B — Emitir la factura en la impresora fiscal y conciliarla con Zoho',
        ...
        gradiente: 'PENDIENTE CON LA JUNTA antes de correr esta maniobra. "Emitir facturaciones en el sistema y en la impresora fiscal" está listada como función tuya, y la impresora está en el recorrido físico del Centro — pero el procedimiento no está escrito en ninguna parte del material: ni en el Curso 2, ni en los cuadernos de maniobras, ni en el Manual. En Panamá la impresora fiscal tiene consecuencias tributarias. Hasta que exista el procedimiento escrito y aprobado, esta función no se le suelta a la Asistente: la emisión fiscal la sigue haciendo quien la venía haciendo, y esta maniobra queda abierta con fecha comprometida. Exige además la Maniobra 5 aprobada: no se emite fiscalmente una factura que todavía no se sabe armar en Zoho.',
        masa: [
          ...
          'El procedimiento escrito de emisión fiscal, aprobado por la Junta. Si no existe, la maniobra no se hace: se abre el pendiente.',
        ],
        pasos: [
        ...
        criterios: [
          ...
          'Ante una diferencia sembrada por el jefe entrenador, se detiene y avisa en vez de reimprimir.',
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    laminas: [
      ...
      },
      {
        ...
        items: [
          ...
          'Frecuencia mensual, y fecha de inicio la del calendario del grupo.',
    ...
    sop: {
      ...
      pasos: [
        ...
        'Frecuencia: mensual. Fecha de inicio: la que corresponda al calendario del grupo.',
        'Artículo: la mensualidad del itinerario y centro correctos.',
    ...
    drills: [
      {
        titulo: 'Maniobra 6 — Crear una factura recurrente y detenerla el mismo día del retiro',
        ...
        gradiente: 'Exige la Maniobra 5 aprobada. Si te cuesta escoger la mensualidad correcta, el paso que falta es la Maniobra 3.',
        masa: [
          'Zoho Books abierto en Ventas → Facturas recurrentes, en la organización de tu Centro.',
          'La lista de niños activos de tu Centro, impresa.',
          'El cuadro de deserciones del Centro.',
        ...
        pasos: [
          'Crea un perfil de factura recurrente: Ventas → Facturas recurrentes → Nueva. Cliente el representante; nombre de perfil que puedas buscar después, con el niño y el grupo; frecuencia mensual; fecha de inicio la del calendario del grupo; artículo la mensualidad del itinerario y Centro correctos.',
          'Guarda y confirma en pantalla que quedó activa.',
          ...
          'Ahora el retiro: el jefe entrenador te da un caso de niño retirado. Busca su perfil y detenlo o cancélalo en el mismo momento.',
          'Si ya se generó una factura del mes que no corresponde cobrar, no la anules: informa a la Administradora y espera su indicación. Redacta el mensaje de aviso frente al jefe entrenador.',
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    voz: 'Registrar un pago se decide en un solo campo. <break time="0.5s"/> Primero lo básico. El pago se aplica SOBRE la factura. Nunca suelto. <break time="0.4s"/> Porque una factura sin pago aplicado queda pendiente, aunque el dinero ya esté en el banco. Y ese padre te aparece debiendo. <break time="0.5s"/> Ese campo es la fecha. <break time="0.4s"/> Zoho te propone la de hoy. Y tú vas a poner la fecha real del pago, leída del comprobante. <break time="0.4s"/> Un padre que paga el treinta, montado el dos con fecha del dos, <break time="0.3s"/> mueve ese cobro al mes siguiente. <break time="0.3s"/> Y te descuadra el cierre del mes anterior. <break time="0.5s"/> Un campo. Un segundo. Y el mes cuadra.',
    ...
    drills: [
      {
        titulo: 'Maniobra 7 — Registrar el pago sobre la factura con la fecha real',
        ...
        gradiente: 'Exige la Maniobra 5 aprobada. Si no distingues cotización de factura, vuelve al glosario y a la Maniobra 5.',
        masa: [
          'Zoho Books abierto en Ventas → Facturas, con una factura pendiente real en pantalla.',
          'Un comprobante de pago real (transferencia, ACH o recibo de efectivo) con su fecha visible.',
          'La bitácora de información importante del Centro, física.',
        ...
        pasos: [
          ...
          'El jefe entrenador te da un comprobante fechado el 30 del mes pasado. Regístralo y explica en qué mes cae ese cobro, y en cuál caería si pusieras la fecha de hoy.',
        ],
        criterios: [
          'Registra tres pagos seguidos —uno completo, uno parcial y uno de mes anterior— con la fecha real, sin consultar el manual.',
          'Dice el saldo resultante de cada factura antes de que el jefe entrenador lo lea en pantalla, y acierta.',
        ...
        errorTipico: 'Dejar la fecha que Zoho propone por defecto, que es la de hoy. Se delata en el paso 9: el pago del 30 aparece en el mes siguiente y ella no lo nota hasta que el jefe entrenador le pregunta en qué mes cayó.',
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 8 — Clasificar la antigüedad de saldos y ejecutar el protocolo del día',
        ...
        gradiente: 'Exige las Maniobras 6 y 7 aprobadas. Si en el informe aparecen vencidos que no son deudas reales, el paso que falta es la Maniobra 6. Si aparecen pagos que sí entraron, el paso que falta es la Maniobra 7. En cualquiera de los dos casos, se devuelve; esta maniobra no se repite más fuerte.',
        masa: [
          'Zoho Books abierto en Informes → Cuentas por cobrar (antigüedad de saldos), impreso o en pantalla.',
          'El teléfono del Centro, encendido y a la mano, para las llamadas de cobranza.',
        ...
        pasos: [
          ...
          'Toma el teléfono y ejecuta las llamadas de la etapa 1: avisa al acudiente que su factura fue emitida y que es importante estar paz y salvo para continuar recibiendo el servicio. El jefe entrenador escucha la llamada.',
        ...
        criterios: [
          ...
          'Hace al menos tres llamadas de cobranza delante del jefe entrenador con tono amigable, buscando cómo ayudar al cliente a ponerse al día — el jefe entrenador las escucha y no oye tono de cobradora.',
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 9 — Clasificar un retiro y aplicar el descuento autorizado',
        ...
        gradiente: 'Exige la Maniobra 8 aprobada. Si no distingues las etapas de vencimiento, vuelve a la Maniobra 8 antes de tocar un descuento.',
        masa: [
          'Zoho Books abierto con una factura vencida real en pantalla.',
        ...
        pasos: [
          'El jefe entrenador hace de representante y te dice una frase de salida. Clasifícala en voz alta en una de las cuatro categorías: no entiende la técnica · pérdida de clase · económico · horario.',
        ...
        criterios: [
          ...
          'Ante la presión del jefe entrenador haciendo de padre que insiste ("dígame usted qué me puede hacer"), no ofrece ningún porcentaje y escala. Lo sostiene tres veces seguidas.',
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    laminas: [
      {
        ...
        texto: 'Hay calendario de mantenimiento y proveedores preestablecidos. Mantenimiento, pintura, instalaciones y reparaciones usan Suplidores del Istmo, S.A. La Asistente Administrativa supervisa el aseo.',
      },
      {
        kicker: 'El flujo',
        ...
        items: [
          ...
          'Cotización sin proveedor establecido: 3 proveedores y comparación.',
          'Gestión de adquisición y evaluación de cumplimiento.',
          'Cancelación al proveedor.',
          'Seguimiento del informe de control de pagos.',
        ],
        cierre: 'Las necesidades de mantenimiento van al FODA mensual para Junta.',
      },
      {
    ...
    sop: {
      ...
      pasos: [
        ...
        'Para un trabajo adicional sin proveedor establecido, presenta el problema al Administrador, pide cotizaciones a 3 proveedores y arma el cuadro comparativo con posibles soluciones.',
      ...
      decide: [
        ...
        { situacion: 'Trabajo adicional sin proveedor establecido', regla: 'Se solicitan cotizaciones a 3 proveedores y se presenta cuadro comparativo con precio, garantía, calidad y recomendación.' },
    ...
    voz: 'Este módulo tiene tres cosas, y una sola idea detrás. <break time="0.5s"/> La idea es prevención, no corrección. Por eso existe un calendario de mantenimiento y proveedores ya establecidos. <break time="0.4s"/> El de mantenimiento, pintura e instalaciones es Suplidores del Istmo. Cambiarlo no es decisión tuya. <break time="0.5s"/> Si el trabajo adicional no tiene proveedor establecido, pides tres cotizaciones. <break time="0.3s"/> No comparas solo precio. <break time="0.3s"/> Comparas precio, garantía y calidad, y llevas problema y soluciones al Administrador. <break time="0.4s"/> Además supervisas que el aseo mantenga el centro en condiciones. <break time="0.5s"/> Y la caja menuda. Es para compras menores. El tope por compra son cuarenta y cinco balboas. <break time="0.5s"/> Una regla, y no la sueltes. Adjunta la foto del recibo en el momento. <break time="0.3s"/> Sin soporte, el gasto no se repone.',
    ...
    bloques: [
      { t: 'sub', texto: 'Lo que tienes que saber' },
      { t: 'p', texto: 'El criterio del Centro es de **prevención, no de corrección**: hay un calendario de mantenimiento y proveedores preestablecidos. El proveedor de mantenimiento (pintura, instalaciones, reparaciones) es **Suplidores del Istmo, S.A.** La Administradora puede buscar otro proveedor en caso de faltas, atrasos o trabajo inadecuado, siempre avisando antes a la Junta Directiva. El personal de aseo está bajo supervisión directa de la Asistente Administrativa.' },
      { t: 'p', texto: 'Cuando aparece una necesidad, adelántate: identifica el problema, busca opciones de solución, cotiza y presenta al Administrador tanto el problema como las posibles soluciones. La necesidad de mantenimiento se informa a la Junta Directiva por medio del FODA mensual.' },
      { t: 'sub', texto: 'El flujo completo' },
      {
        t: 'pasos',
        items: [
          'Confección del calendario de mantenimiento.',
          '**Cotización** — si no hay proveedor establecido para el trabajo adicional, se solicitan cotizaciones a 3 proveedores y se comparan.',
      ...
      { t: 'p', texto: 'No se compara solo por precio. Se compara precio, garantía y calidad, y se deja escrita la recomendación con su razón. En la imagen del Manual se recomienda el proveedor C aunque no tiene el menor precio, porque su garantía y calidad son superiores. Ejemplo del formato:' },
      {
        t: 'tabla',
    ...
    drills: [
      {
        titulo: 'Maniobra 10 — Comparar cotizaciones de proveedor y reponer la caja menuda',
        ...
        gradiente: 'Exige la Maniobra 2 aprobada. Si el gasto puede caer en la organización equivocada, no estás lista para esta maniobra: vuelve a la Maniobra 2.',
        masa: [
          'El fondo de caja menuda físico, contado, con todos sus recibos.',
          'Zoho Books abierto en Compras → Gastos y en Compras → Facturas de proveedor.',
          'Tres cotizaciones de proveedor, reales o de práctica, para una necesidad de tu Centro.',
        ...
        pasos: [
          ...
          'Escoge una necesidad que no tenga proveedor establecido y pide tres cotizaciones. Recuerda que el proveedor de mantenimiento de los Centros —pintura, instalaciones, reparaciones— es Suplidores del Istmo, S.A.',
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 11 — Montar la nómina de un Coach con su factura de servicio adjunta',
        ...
        gradiente: 'Exige la Maniobra 10 aprobada. Si te enredas montando una factura de proveedor, ese es el paso que falta.',
        masa: [
          'Una factura de servicio real de un Coach, en la mano o en pantalla.',
          'Zoho Books abierto en Compras → Facturas de proveedor.',
          'Las listas de asistencia firmadas por los Coaches con la hora de llegada anotada.',
        ...
        pasos: [
          ...
          'El jefe entrenador te presenta el caso de un colaborador que pide su pago por ACH a una cuenta que no es suya. Di qué documento exiges antes de hacer ese pago y dónde se archiva.',
        ],
        criterios: [
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 12 — Cuadrar matrículas facturadas, kits pedidos y niños nuevos',
        ...
        gradiente: 'Exige las Maniobras 3, 5 y 6 aprobadas. Cuando una matrícula aparece facturada al Centro equivocado, el paso que falta es la Maniobra 3. Cuando falta una matrícula por facturar, es la Maniobra 5. Cuando sobran facturas de niños que ya no están, es la Maniobra 6.',
        masa: [
          'Zoho Books abierto en Informes, en la organización de tu Centro.',
          'El cuadro de negocio del mes pasado, impreso.',
          'El formato KITS A PEDIR y los correos de solicitud de kits del mes.',
        ...
        errorTipico: 'Cuadrar por resta: ver que faltan dos y anotar dos de más en kits para que dé. Se delata cuando el jefe entrenador le pide señalar en pantalla las facturas que respaldan ese número y no aparecen. Los datos deben ser veraces, precisos, completos y verificables; omitir, manipular o falsear información es una falta grave de carácter laboral, ético y legal.',
      },
    ],
  },
  ...
  // ────────────────────────────────────────────────────────────────────────
  {
    ...
    drills: [
      {
        titulo: 'Maniobra 13 — Auditar tu propio mes contra los diez errores caros',
        ...
        gradiente: 'Exige las Maniobras de la 1 a la 12 aprobadas. Cada error de la tabla apunta a una maniobra: si en la auditoría te trabas en un error, se te devuelve a su maniobra, no se repite esta.',
        masa: [
          'Zoho Books abierto con el historial del mes pasado de tu Centro.',
        ...
        pasos: [
          ...
          'Al final de la semana, reporta al jefe entrenador qué tarea se te hizo más difícil sostener y por qué.',
        ],
        criterios: [
          ...
          'Dice para cada caso qué costó, en dinero o en indicador, sin que el jefe entrenador se lo sugiera.',
          'El tablero está pegado en su puesto y marcado los cinco días, verificado por el jefe entrenador en dos revisiones sorpresa.',
          'Nombra los diez errores y su antídoto sin mirar la tabla.',
        ],
        errorTipico: 'Auditarse en blanco: "yo no cometí ninguno de estos". Se delata cuando el jefe entrenador hace la misma búsqueda y encuentra dos en diez minutos. Un mes real sin ningún caso casi nunca existe; lo que existe es una revisión hecha por encima.',
      },
      {
        titulo: 'Maniobra 14 — Integrador: una noche de clase de prueba, de principio a fin',
        ...
        gradiente: 'Exige las Maniobras 3, 4, 5 y 7 aprobadas. Esta maniobra no enseña nada nuevo: pone junto lo que ya sabes bajo presión de tiempo real. Si algo se cae, se identifica qué maniobra era y se devuelve a esa.',
        masa: [
          'Una clase de prueba real de tu Centro, agendada, con el jefe entrenador presente en el Centro esa noche.',
        ...
        criterios: [
          ...
          'Entrega los dos indicadores calculados esa misma noche, y coinciden con lo que el jefe entrenador contó en la puerta.',
          'Ningún contacto quedó duplicado y ninguno quedó sin cédula ni correo.',
          'El jefe entrenador la observó recibir a los padres sin tutear a ninguno.',
        ],
      ...
      {
        titulo: 'Maniobra 15 — Integrador: el cierre de mes completo',
        ...
        gradiente: 'Exige las Maniobras 10, 11 y 12 aprobadas. Si el cuadre no da, el paso que falta es la Maniobra 12; si falta un adjunto de Coach, es la Maniobra 11; si el fondo no cuadra, es la Maniobra 10.',
        masa: [
      ...
      {
        titulo: 'Maniobra 16 — Integrador: una semana de cobranza completa',
        ...
        gradiente: 'Exige las Maniobras 6, 7, 8 y 9 aprobadas. Un vencido falso en el informe manda a la Maniobra 6; un pago que entró y no aparece manda a la Maniobra 7; un descuento ofrecido de más manda a la Maniobra 9.',
        masa: [
        ...
        criterios: [
          ...
          'Sostiene el tono amigable en todas las llamadas que el jefe entrenador escucha, incluso con el padre molesto, y no ofrece ningún descuento por su cuenta.',
