...
export const HAT_COA = [
  {
    ...
    bloques: [
      ...
      { t: 'p', texto: 'De los cuatro, el único que el sistema ya cuenta solo es el primero, y conviene que sepas exactamente qué mide antes de que alguien te lo enseñe en una pantalla.' },
      {
        ...
        filas: [
          ...
          ['Dónde lo ves tú', 'En ninguna pantalla tuya: vive en el Resumen del Centro, que tu cuenta no abre. Te llega hablado, en la reunión con tu Administradora'],
        ],
      },
      {
        t: 'tabla',
      ...
      { t: 'nota', tono: 'regla', titulo: 'Regla clave', texto: 'Tú enseñas, registras, propones y reportas. Las decisiones de esta tabla no son tuyas. Llevarlas a quien le toca no es debilidad: es tu puesto funcionando bien.' },
      {
        ...
        filas: [
          ...
          ['Autorizar una Clase de Reforzamiento', 'Administrador de Centro', 'Llenas la plantilla de solicitud con los tres requisitos verificados y se la entregas al Asistente Administrativo, haciendo partícipe a tu Administrador'],
          ['Elegir qué Coach da esa Clase de Reforzamiento', 'Administrador de Centro, tomando en cuenta aptitudes y personalidad', 'Nada. El Manual dice que preferiblemente no la dé el Coach del niño: otra voz explica lo mismo de otra manera'],
      ...
      { t: 'nota', tono: 'ojo', titulo: 'Dos firmas distintas que el sistema puede confundir', texto: 'Tu ADMINISTRADORA te firma la maniobra de tu puesto, dentro de tu Centro base. Tu MASTER COACH te certifica el nivel de la técnica, que no es un rol de este sistema. Un puesto tomado no habilita un nivel, y un nivel certificado no cierra tu puesto. Si das clases en dos Centros, normalmente te firma la Administradora de tu Centro base, que es el que aparece en tu cuenta; también pueden firmarte tu Coordinador Operativo o la gerencia. Lo que ninguno de ellos hace es certificarte un nivel: eso es del Master Coach.' },

      { t: 'sub', texto: 'De quién recibes y a quién entregas' },
      { t: 'p', texto: 'Tu puesto es un nodo de una cadena, no un puesto suelto. Si un insumo no te llega, tu producto no sale, y es tu trabajo reclamarlo, no esperarlo.' },
      {
        t: 'tabla',
      ...
      },
      {
        ...
        filas: [
          ...
          ['La solicitud de Clase de Reforzamiento', 'Asistente Administrativa, haciendo partícipe al Administrador', 'Cuando se cumplen los tres requisitos'],
    ...
    // LA HOJA DE UNA PÁGINA. Es este paquete reducido a lo que se tiene AL LADO
    // mientras se trabaja: el rodeo de la clase en orden, quién decide lo que no
    // decides tú, y los tres errores que cuestan un niño. Cada línea sale de un
    // bloque de arriba; aquí no se agrega ni una regla nueva ni una cifra nueva.
    sop: {
      proceso: 'Tu puesto: Coach ALOHA',
      cuando: 'Cada día de clase, y ante cualquier duda.',
      producto: 'Niños que se quedan y suben de nivel: tu grupo entero llegando al Cierre, con su asistencia marcada al instante, su bitácora escrita clase por clase y su retroalimentación en el portafolio.',
      pasos: [
        'Llega 20 minutos antes del inicio de tu clase: 15 minutos son la tolerancia, y de ahí sale tu bono.',
        'Recibe la lista de tu grupo, firma tu asistencia y deja que la Asistente coloque tu hora de llegada.',
        'Da la clase con el chaleco oficial ALOHA puesto.',
        'Marca la asistencia al instante de dar la clase, con la leyenda de colores. Nunca al final de la semana.',
        'Avisa a la Asistente y al Administrador apenas un niño llegue a su segunda ausencia.',
        'Escribe la bitácora del día en el libro de record del Centro, con fecha y firma.',
        'Sube la retroalimentación en sándwich al portafolio del niño en Class Dojo, una vez por semana.',
        'Evalúa al niño en el libro cada 3 semanas de trabajo, y entrega la ficha de Campeonato cada dos clases desde la semana 4.',
        'Si hace falta reforzamiento, llena la plantilla con los tres requisitos y entrégasela al Asistente Administrativo, haciendo partícipe a tu Administrador.',
      ],
      decide: [
        { situacion: 'Un padre te habla de retiro, de precio o de descuento', regla: 'Decide el Administrador de Centro: son sus herramientas de no salida. Tú lo escuchas, lo llevas con él y le reportas lo que ves en clase.' },
        { situacion: 'Quién autoriza y quién da la Clase de Reforzamiento', regla: 'Autoriza y elige el Administrador, por aptitudes y personalidad. Tú entregas la plantilla al Asistente Administrativo, haciendo partícipe al Administrador; y preferiblemente no la das tú.' },
        { situacion: 'Quién te firma qué', regla: 'La Administradora firma la maniobra de tu puesto. El Master Coach certifica tu nivel de la técnica. Un puesto tomado no habilita un nivel.' },
      ],
      errores: [
        'Marcar la asistencia de toda la semana el viernes: sin asistencia al instante no hay aviso de dos ausencias.',
        'Dar tu número personal a un padre o abrir un grupo de WhatsApp del salón: todo pasa por Class Dojo y por el Centro.',
        'Prometerle un descuento al padre o firmarle una constancia: emitirlas sin autorización corporativa es falta grave.',
      ],
    },
