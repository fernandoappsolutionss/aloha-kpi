...
export const COORDINACION = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    laminas: [
      ...
      },
      {
        ...
        cierre: 'Los cinco primeros salen del trámite. Los seis restantes son los que pide un inspector.',
      },
    ],
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    laminas: [
      ...
      {
        kicker: 'Lo que este puesto tiene y el Manual no',
