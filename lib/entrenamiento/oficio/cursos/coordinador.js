...
// Doce módulos: of-cop-1 … of-cop-12, órdenes 14 a 25 (of-cop-11 y 12 son la
// Curva 13 · Caja: leerla y tomarla). El paquete del puesto
...
export const COORDINACION = [
  ...
  // 24 · of-cop-11
  // ══════════════════════════════════════════════════════════════════════════
  // La herramienta Curva 13 · Caja (/dashboard/caja), leída columna por columna.
  // Cada regla de este módulo sale del código, no del Manual: si cambia
  // lib/caja/curva.mjs (piso, semáforo, baldes, perfil de cobro), este módulo se
  // corrige en la misma edición.
  {
    id: 'of-cop-11',
    curso: 'coordinacion',
    orden: 24,
    roles: ['coordinador'],
    titulo: 'Curva 13 · Caja: cómo funciona la herramienta',
    duracionMin: 25,
    requiere: ['of-hat-cop'],
    fuente: [
      'descripcion-del-puesto-fernando#curva-13-caja',
      'app/dashboard/caja/page.js',
      'lib/caja/curva.mjs',
      'lib/caja/semanas.mjs',
      'lib/caja/reglas.mjs',
    ],

    pfv: 'Leer la Curva de 13 semanas de Altavia, de F&F y del consolidado y decir, con los números de la pantalla, cuál es la primera semana en que la plata no alcanza y por qué.',
    voz: 'La Curva de trece semanas responde una sola pregunta. <break time="0.4s"/> Cuánta plata va a quedar disponible cada semana de los próximos tres meses, <break time="0.3s"/> y cuál es la primera semana en que no alcanza. <break time="0.5s"/> Arranca con el saldo real del banco. <break time="0.3s"/> Le suma el cobro que se espera, <break time="0.3s"/> le resta los pagos programados, <break time="0.3s"/> y aparta la parte del dueño y la reserva de impuesto. <break time="0.4s"/> Lo que queda es el disponible. <break time="0.5s"/> Si el disponible baja de cero, la semana sale en rojo. <break time="0.3s"/> Si queda positivo pero por debajo de dos semanas de gasto, sale en ámbar. <break time="0.4s"/> La herramienta no decide nada. <break time="0.3s"/> Te dice con meses de anticipación dónde se va a apretar la caja, <break time="0.3s"/> para que la decisión se tome a tiempo y no el día del pago.',

    masa: [
      'La pantalla Curva 13 · Caja abierta, con los botones Altavia, F&F y Consolidado.',
      'La tabla de la curva con sus ocho columnas, semana por semana.',
      'La lista de Pagos programados de cada empresa.',
      'El último extracto de cada cuenta del banco.',
    ],
    ...
    laminas: [
      {
        kicker: 'Para qué existe',
        titulo: 'Una sola pregunta, con tres meses de anticipación',
        texto: 'Cuánta plata va a quedar disponible cada semana de las próximas 13, y cuál es la primera semana en que no alcanza.',
      },
      {
        titulo: 'La cuenta de cada semana',
        items: [
          'Saldo inicial más ingresos esperados.',
          'Menos pagos programados y menos la parte del dueño.',
          'Eso es el saldo final. Menos la reserva de impuesto, el disponible.',
        ],
      },
      {
        kicker: 'El semáforo',
        titulo: 'Tres colores, dos rayas',
        items: [
          'Rojo: el disponible baja de cero.',
          'Ámbar: positivo, pero bajo el piso de 2 semanas de gasto.',
          'Verde: por encima del piso.',
        ],
        cierre: 'La frase de arriba de la curva nombra la primera semana que no está en verde.',
      },
      {
        titulo: 'El cobro no cae parejo en el mes',
        texto: 'La curva reparte el cobro de los últimos 3 meses cerrados por bloques del mes. En Altavia casi la mitad entra del 22 al cierre: a mitad de mes la curva baja y es normal.',
      },
      {
        kicker: 'Los baldes',
        titulo: 'Antes de gastar, se aparta',
        texto: 'De cada cobro sale un porcentaje para el dueño y otro para la reserva de impuesto. La reserva no es plata disponible: ya tiene dueño, que es el fisco.',
      },
      {
        kicker: 'El error caro',
        titulo: 'Leer el saldo de hoy como si fuera el de la semana 8',
        texto: 'Hoy puede haber 30 mil en el banco y la semana 8 salir en rojo. La curva existe para ver esa semana antes de llegar a ella.',
      },
    ],

    sop: {
      proceso: 'Leer la Curva 13 de una empresa',
      cuando: 'Cada vez que abras la pantalla Curva 13 · Caja, antes de hablar de la caja con nadie.',
      producto: 'La primera semana en alerta de cada vista, con su fecha, su color, su disponible y el pago que la explica.',
      pasos: [
        'Elige la vista: Altavia, F&F o Consolidado.',
        'Lee el saldo en bancos de hoy y revisa que ninguna cuenta tenga aviso de saldo viejo.',
        'Mira si el cobro promedio dice estimado desde Zoho: si lo dice, la curva todavía no se usa para decidir.',
        'Lee la frase de arriba de la curva: primera semana que no está en verde, su fecha y su disponible.',
        'Busca esa semana en la tabla y recorre sus columnas: saldo inicial, ingresos, egresos, dueño y reserva.',
        'En el detalle de egresos, señala el pago que más pesa esa semana.',
        'Compara el disponible con el piso de seguridad y mira si la columna Línea pide giro.',
        'Repite en las otras dos vistas.',
      ],
      decide: [
        { situacion: 'La curva baja a mitad de mes y sube al cierre', regla: 'Es el perfil de cobro, no una caída. Solo cuenta como alerta si el disponible cruza el piso o el cero.' },
        { situacion: 'El cobro dice estimado desde Zoho', regla: 'Se lee para orientarse, no para decidir. Primero se suben los extractos del último mes cerrado.' },
      ],
      errores: [
        'Contestar con el saldo de hoy cuando la pregunta es la semana en alerta.',
        'Contar la reserva de impuesto como plata disponible porque está en el banco.',
      ],
    },

    bloques: [
      { t: 'sub', texto: 'Qué es la Curva de 13 semanas' },
      { t: 'p', texto: 'La pantalla **Curva 13 · Caja** responde una sola pregunta: **cuánta plata va a quedar disponible cada semana de los próximos tres meses, y cuál es la primera semana en que no alcanza.** Se lleva por empresa —Altavia y F&F— y en un consolidado que suma las dos semana por semana.' },
      { t: 'p', texto: 'La ventana son 13 semanas que arrancan el **lunes de la semana en curso**. Se corre sola: al pasar el lunes, la semana 1 se va y aparece una semana 13 nueva, sin botón ni cierre de mes.' },
      { t: 'nota', tono: 'ojo', titulo: 'Pendiente con la Junta Directiva', texto: 'La Curva de 13 semanas y su lectura las diseñó el dueño con la herramienta; el Manual de Operaciones no las menciona. Hasta que la Junta Directiva las escriba, son práctica de la operación: úsala para anticipar y avisar, no como fundamento para sancionar a nadie.' },

      { t: 'sub', texto: 'La cuenta de cada semana, columna por columna' },
      {
        t: 'tabla',
        encabezados: ['Columna', 'Qué es', 'De dónde sale'],
        filas: [
          ['Saldo inicial', 'Con cuánto arranca la semana. En la semana 1 es el saldo en bancos de hoy', 'Los extractos subidos de las cuentas operativas'],
          ['Ingresos', 'El cobro que se espera esa semana', 'El promedio de cobro de los últimos 3 meses cerrados, o el ajuste a mano'],
          ['Egresos', 'Los pagos programados que caen esa semana, con su detalle', 'La lista de Pagos programados'],
          ['Dueño', 'La parte del cobro que se separa para el dueño', 'El balde del dueño; en la semana 1 suma lo que falta por separar'],
          ['Reserva impuesto', 'Lo apartado para impuestos, acumulado hasta que se paga', 'El balde de impuesto'],
          ['Disponible', 'Saldo final menos la reserva de impuesto', 'La cuenta de la fila'],
          ['Línea', 'Cuánto habría que girar de la línea de crédito si el disponible sale negativo', 'La cuenta de la fila'],
        ],
      },
      { t: 'p', texto: 'La cuenta completa, en palabras: **saldo final = saldo inicial + ingresos − egresos − dueño.** El disponible es ese saldo final menos la reserva de impuesto. El saldo final de una semana es el saldo inicial de la siguiente: por eso un pago grande en la semana 3 se sigue sintiendo en la 9.' },

      { t: 'sub', texto: 'De dónde sale el saldo de hoy' },
      { t: 'p', texto: 'El saldo en bancos de hoy es el último saldo que trajo el banco en cada cuenta operativa, más los movimientos que llegaron después. **No se escribe a mano**: sale de los extractos que se suben en la misma pantalla.' },
      { t: 'p', texto: 'Si una cuenta lleva **más de 7 días** sin saldo del banco, la pantalla lo avisa con un ⚠️ en Saldo por cuenta. Con un saldo viejo, toda la curva arranca de un número falso, y las 13 semanas heredan el error.' },

      { t: 'sub', texto: 'Cómo proyecta el cobro' },
      { t: 'p', texto: 'La curva toma el cobro real de los **últimos 3 meses cerrados** y lo reparte en cuatro bloques del mes: del 1 al 7, del 8 al 14, del 15 al 21 y del 22 al cierre. El cobro no cae parejo: en Altavia cerca del 42 por ciento entra en el último bloque. Por eso la curva baja a mitad de mes y sube al cierre, y eso no es una alarma: es el perfil del negocio.' },
      { t: 'p', texto: 'Si una empresa todavía no tiene un mes cerrado de extractos, la curva usa el cobro de referencia de Zoho y lo marca **(estimado desde Zoho — sube extractos)**. Ese número sirve para arrancar, no para decidir.' },
      { t: 'p', texto: 'El ingreso de cualquier semana se puede ajustar a mano tocando su monto: queda marcado con ✎ y se puede **Volver a la proyección**. En la semana 1 el ajuste es solo **de mañana al domingo**: lo cobrado hoy ya está en el saldo del banco, y si escribes la semana entera lo cuentas dos veces.' },

      { t: 'sub', texto: 'Los baldes: dueño e impuesto' },
      { t: 'p', texto: 'De cada cobro, antes de contarlo como disponible, se aparta un porcentaje para el **dueño** y otro para la **reserva de impuesto**. Hoy son 15 y 8 por ciento en Altavia y 8 y 8 por ciento en F&F, vigentes desde el 28 de septiembre de 2026, y la escalera sube por trimestre hacia 35 y 15.' },
      { t: 'p', texto: 'La parte del dueño **nunca se carga como pago programado**: la separan los baldes solos, y cargarla también la descontaría dos veces. El sistema lo rechaza.' },

      { t: 'sub', texto: 'El semáforo de la curva' },
      {
        t: 'tabla',
        encabezados: ['Color', 'Cuándo sale'],
        filas: [
          ['Rojo', 'El disponible de la semana baja de cero'],
          ['Ámbar', 'El disponible es positivo pero está por debajo del piso de seguridad'],
          ['Verde', 'El disponible está por encima del piso'],
        ],
      },
      { t: 'p', texto: 'El **piso de seguridad** es dos semanas de gasto: el promedio semanal de egresos de las 13 semanas, por dos. En el gráfico es la raya punteada; la raya del cero es la otra.' },
      { t: 'p', texto: 'La **línea de crédito** de Banco General es el respaldo del grupo para una semana corta: en el resumen sale su monto disponible, que es su límite menos lo ya girado. Cuando una semana sale negativa, la columna Línea dice cuánto habría que girar, y si pasa del disponible de la línea lo marca con ⛔ **excede la línea**.' },
      { t: 'p', texto: 'Arriba de la curva, una frase resume todo: la **primera semana que no está en verde**, su fecha y su disponible. Esa frase es el titular; la tabla es la explicación.' },

      { t: 'sub', texto: 'Los movimientos: subir y clasificar' },
      { t: 'p', texto: 'En **Subir extracto** entra el OFX de Banco General, el Excel de movimientos de St. Georges o el PDF de su estado de cuenta. Antes de guardar, la pantalla muestra cuántos movimientos son nuevos, cuántos ya estaban y cuántos quedarán por clasificar. Subir el mismo archivo dos veces no duplica nada.' },
      { t: 'p', texto: 'Lo que el sistema no reconoce cae en **Por clasificar**. Cada movimiento se clasifica en una clase, y si se marca **Crear regla con este texto**, los próximos con ese texto se clasifican solos.' },
      {
        t: 'tabla',
        titulo: 'Las clases que mueven la curva',
        encabezados: ['Clase', 'Qué hace en la curva'],
        filas: [
          ['Ingreso', 'Alimenta el promedio de cobro y los baldes'],
          ['Planilla, regalía, kits, alquiler, servicios, impuestos, otros operativos', 'Son egresos: la historia real de lo que se paga'],
          ['Dueño', 'Lo que ya se le transfirió al dueño: baja lo que falta por separar'],
          ['Línea de crédito', 'Giros y abonos de la línea: suben o bajan lo usado'],
          ['Intercompañía', 'Pases entre Altavia, F&F y empresas hermanas: no se proyecta'],
          ['Traspaso entre cuentas propias y Resguardo campeonatos C&C', 'No entran a la curva: no cambian la caja de la empresa'],
        ],
      },
      ...
      { t: 'sub', texto: 'Errores que cuestan dinero' },
      {
        t: 'lista',
        items: [
          'Leer solo el saldo de hoy. Hoy puede haber plata de sobra y la semana 8 salir en rojo.',
          'Alarmarse por la bajada de mitad de mes: es el perfil de cobro, no una caída.',
          'Escribir en la semana 1 el cobro de la semana entera: lo de hoy ya está en el banco y se cuenta dos veces.',
          'Tomar decisiones con el cobro marcado estimado desde Zoho, sin extractos reales.',
        ],
      },
    ],
    ...
    quiz: [
      {
        pregunta: '¿Qué pregunta responde la Curva de 13 semanas?',
        opciones: [
          'Cuánto vendió cada centro el mes pasado',
          'Cuánto le debe cada representante a la empresa',
          'Cuánta plata queda disponible cada semana de los próximos tres meses y cuál es la primera que no alcanza',
          'Cuánto hay que pagar de impuestos al cierre del año',
        ],
        explicacion: 'Es una herramienta de anticipación: su titular es la primera semana que no está en verde.',
        repasa: ['saldo'],
      },
      {
        pregunta: 'Las 13 semanas de la curva…',
        opciones: [
          'arrancan el lunes de la semana en curso y se corren solas cada semana',
          'arrancan el día 1 de cada mes y se reinician al cierre',
          'las define a mano quien sube los extractos',
          'son siempre las 13 semanas del trimestre fiscal',
        ],
        explicacion: 'Al pasar el lunes, la semana 1 se va y aparece una semana 13 nueva, sin botón ni cierre de mes.',
      },
      {
        pregunta: 'El disponible de una semana es…',
        opciones: [
          'el saldo del banco de hoy',
          'el saldo final de la semana menos la reserva de impuesto',
          'los ingresos de la semana menos los egresos',
          'el límite de la línea de crédito menos lo girado',
        ],
        explicacion: 'Saldo final = saldo inicial + ingresos − egresos − dueño. La reserva de impuesto ya tiene dueño y no se cuenta como disponible.',
        repasa: ['ingreso', 'egreso'],
      },
      {
        pregunta: 'Una semana sale en ÁMBAR cuando…',
        opciones: [
          'el disponible baja de cero',
          'hay movimientos por clasificar',
          'el cobro de esa semana es estimado',
          'el disponible es positivo pero está por debajo del piso de dos semanas de gasto',
        ],
        explicacion: 'Rojo es bajo cero; ámbar es positivo pero bajo el piso; verde es sobre el piso.',
      },
      {
        pregunta: 'En la semana 1, el ajuste manual del ingreso cubre…',
        opciones: [
          'solo de mañana al domingo',
          'la semana entera, de lunes a domingo',
          'el mes completo',
          'solo el día de hoy',
        ],
        explicacion: 'Lo cobrado hoy ya está en el saldo del banco. Si escribes la semana entera, lo cuentas dos veces.',
      },
      {
        pregunta: 'El cobro que proyecta la curva sale de…',
        opciones: [
          'la meta de ventas del trimestre',
          'el cobro real de los últimos 3 meses cerrados de extractos, repartido por bloques del mes',
          'lo que cada Administrador del Centro promete en la reunión',
          'el número de niños activos por la mensualidad',
        ],
        explicacion: 'Sin un mes cerrado de extractos, usa el cobro de referencia de Zoho y lo marca estimado.',
        repasa: ['ingreso'],
      },
      {
        pregunta: 'Para que la curva descuente la parte del dueño, se agrega como pago programado.',
        opciones: ['Verdadero', 'Falso'],
        explicacion: 'La separan los baldes solos. Cargarla también como pago la descontaría dos veces, y el sistema lo rechaza.',
      },
      {
        pregunta: 'El barrido de St. Georges a Banco General dentro de la misma empresa se clasifica como…',
        opciones: [
          'ingreso, porque entra plata a Banco General',
          'otros operativos',
          'traspaso entre cuentas propias, que no entra a la curva',
          'intercompañía',
        ],
        explicacion: 'Mover plata de una cuenta propia a otra no cambia la caja de la empresa. Contarlo como ingreso inflaría el cobro.',
    ...
    drills: [
      {
        titulo: 'Maniobra 1 — Leer la curva de las dos empresas en voz alta',
        fuente: 'app/dashboard/caja/page.js',
        proposito: 'Que con la pantalla real delante digas, empresa por empresa, de dónde sale cada número y cuál es la primera semana en alerta, sin inventar ninguna cifra.',
        gradiente: 'Exige este módulo leído con la pantalla Curva 13 · Caja abierta. La caja se abre por persona, no por puesto: si tu usuario no entra, la maniobra se hace en la pantalla de quien sí tiene acceso, a su lado.',
        masa: [
          'La pantalla Curva 13 · Caja abierta en Altavia, F&F y Consolidado.',
          'El último extracto de cada cuenta operativa.',
        ],
        pasos: [
          'Abre Curva 13 · Caja en Altavia y lee el saldo en bancos de hoy y la fecha del dato de cada cuenta.',
          'Di si alguna cuenta tiene aviso de saldo viejo y qué le pasa a la curva por eso.',
          'Lee la frase de arriba de la curva: primera semana en alerta, su fecha y su disponible.',
          'Explica esa semana con sus columnas: saldo inicial, ingresos, egresos, dueño y reserva.',
          'Señala en el detalle de egresos el pago que más pesa esa semana.',
          'Repite en F&F y en Consolidado, y di en cuál de las tres vistas no se puede ajustar nada y por qué.',
        ],
        criterios: [
          'Dice la primera semana en alerta de cada vista con su fecha, su color y su disponible, sin mirar notas.',
          'Explica la cuenta de la semana columna por columna y la cuadra en voz alta contra la pantalla.',
          'Distingue la bajada normal de mitad de mes de una semana que de verdad no alcanza.',
          'Explica por qué la reserva de impuesto no es plata disponible aunque esté en el banco.',
        ],
        errorTipico: 'Contestar con el saldo en bancos de hoy cuando se pregunta por la semana en alerta. El saldo de hoy es el punto de partida de la curva, no su respuesta.',
      },
    ],
  },
  // ══════════════════════════════════════════════════════════════════════════
  // 25 · of-cop-12
  // ══════════════════════════════════════════════════════════════════════════
  // Tomar el puesto de la curva: la revisión de cada lunes. of-cop-11 enseña a
  // leerla; este enseña a mantenerla verdadera y a subir la alerta a tiempo.
  {
    id: 'of-cop-12',
    curso: 'coordinacion',
    orden: 25,
    roles: ['coordinador'],
    titulo: 'Tomar la Curva 13: la revisión de cada lunes',
    duracionMin: 30,
    requiere: ['of-cop-11'],
    fuente: [
      'descripcion-del-puesto-fernando#curva-13-caja',
      'components/caja/ImportarExtracto.js',
      'components/caja/BandejaClasificar.js',
      'components/caja/Compromisos.js',
      'lib/caja/reglas.mjs',
    ],

    pfv: 'Cada lunes, la curva de las dos empresas al día —extractos de la semana subidos, la bandeja Por clasificar en cero y los pagos programados con su monto real— y la frase de la semana entregada a la Junta Directiva ese mismo día.',
    voz: 'La curva es tan verdadera como lo que se le sube. <break time="0.4s"/> Un extracto viejo la hace arrancar de un saldo falso. <break time="0.3s"/> Un cobro que se queda por clasificar no cuenta en el promedio, <break time="0.3s"/> y la proyección sale más baja de lo que es. <break time="0.5s"/> Por eso tomar la curva es una rutina de cada lunes. <break time="0.3s"/> Subes los extractos de la semana. <break time="0.3s"/> Vacías la bandeja. <break time="0.3s"/> Revisas los pagos programados. <break time="0.3s"/> Y escribes una frase con la primera semana en alerta. <break time="0.5s"/> Tú no giras la línea de crédito ni mueves un pago. <break time="0.3s"/> Tu trabajo es que la Junta Directiva vea la semana en rojo con semanas de anticipación, <break time="0.3s"/> y no el día que el pago rebota.',

    masa: [
      'Los extractos de la semana de cada cuenta: OFX de Banco General y Excel de St. Georges.',
      'La bandeja Por clasificar de la pantalla Curva 13 · Caja.',
      'La lista de Pagos programados de Altavia y de F&F.',
      'La frase de la semana anterior, para compararla.',
    ],
    ...
    laminas: [
      {
        kicker: 'Para qué existe',
        titulo: 'La curva es tan verdadera como lo que se le sube',
        items: [
          'Extracto viejo: arranca de un saldo falso.',
          'Cobro sin clasificar: no entra al promedio y la proyección baja.',
          'Pago con monto estimado: la semana sale mejor o peor de lo que es.',
        ],
      },
      {
        kicker: 'La rutina',
        titulo: 'Cuatro cosas, cada lunes',
        items: [
          'Subir los extractos de la semana de todas las cuentas.',
          'Dejar la bandeja Por clasificar en cero.',
          'Revisar altas, bajas y montos de los pagos programados.',
          'Escribir la frase de la semana y mandarla ese día.',
        ],
      },
      {
        titulo: 'La regla se escribe con el nombre, no con el banco',
        texto: 'Casi todas las transferencias empiezan igual: BANCA EN LINEA TRANSFERENCIA A. Una regla con ese texto se traga todas. El texto de la regla es lo que distingue: el nombre del proveedor.',
      },
      {
        kicker: 'Lo que no decides tú',
        titulo: 'Tú avisas, la Junta decide',
        items: [
          'Girar de la línea de crédito.',
          'Mover o partir un pago.',
          'Cambiar los porcentajes de los baldes.',
        ],
        cierre: 'Tu trabajo es que la semana en rojo se vea con tiempo.',
      },
      {
        kicker: 'El error caro',
        titulo: 'La bandeja con 50 movimientos',
        texto: 'Cada cobro que se queda por clasificar no cuenta en el promedio ni en el balde del dueño. Con 50 en la bandeja, la curva ya no dice la verdad.',
      },
    ],

    sop: {
      proceso: 'Revisar y entregar la Curva 13 de la semana',
      cuando: 'Cada lunes, antes del mediodía.',
      producto: 'La curva de Altavia y de F&F al día y la frase de la semana entregada a la Junta Directiva.',
      pasos: [
        'Descarga los extractos de la semana de cada cuenta: OFX de Banco General y Excel de St. Georges.',
        'Súbelos uno por uno en Subir extracto y lee el resumen antes de guardar: nuevos, ya cargados y por clasificar.',
        'Si sale el aviso de descuadre de St. Georges, baja el estado oficial y anota el movimiento que falta.',
        'Confirma en Saldo por cuenta que ninguna cuenta operativa quede con aviso de saldo viejo.',
        'Vacía la bandeja Por clasificar: cada movimiento con su clase.',
        'Si el movimiento se va a repetir, marca Crear regla y deja en el texto solo el nombre que lo distingue.',
        'Revisa los Pagos programados de cada empresa: altas, bajas y cambios de monto de la semana.',
        'Reemplaza cada pago marcado (estimado) por su monto real en cuanto llegue la factura.',
        'Ajusta el ingreso de una semana solo con evidencia escrita; si no la hay, deja la proyección.',
        'Lee la frase de arriba de la curva en Altavia, en F&F y en Consolidado.',
        'Escribe la frase de la semana y mándala a la Junta Directiva el mismo lunes.',
      ],
      decide: [
        { situacion: 'Una semana sale en rojo o la columna Línea pide giro', regla: 'No giras la línea ni mueves pagos. Sube a la Junta Directiva ese mismo día con la semana, el monto que falta y el pago que la hunde.' },
        { situacion: 'No sabes de qué es un movimiento', regla: 'No lo adivines ni crees regla. Pregúntale ese día a quien lo pagó o lo cobró y clasifícalo con la respuesta.' },
        { situacion: 'Te piden cambiar el porcentaje del dueño o del impuesto', regla: 'Los baldes los decide la Junta Directiva con su escalera. Tú reportas cómo quedaría la curva, no los cambias.' },
      ],
      errores: [
        'Crear una regla con BANCA EN LINEA TRANSFERENCIA A: clasifica igual a todo el que recibe una transferencia.',
        'Clasificar el barrido entre cuentas propias como ingreso o egreso: infla el cobro o el gasto.',
        'Mandar la frase sin haber subido los extractos: la curva arranca de un saldo viejo.',
      ],
    },

    bloques: [
      { t: 'sub', texto: 'Lo que significa tomar la curva' },
      { t: 'p', texto: 'La curva no se alimenta sola. **Es tan verdadera como lo que se le sube**: el saldo sale de los extractos, el cobro proyectado sale de los ingresos ya clasificados y los egresos salen de la lista de pagos programados. Si una de las tres fuentes se atrasa, la curva sigue pintando colores, pero ya no dice la verdad.' },
      { t: 'p', texto: 'Tomar el puesto de la curva es hacerte dueño de esas tres fuentes cada semana, y de la frase que la Junta Directiva lee para decidir.' },
      { t: 'nota', tono: 'ojo', titulo: 'Pendiente con la Junta Directiva', texto: 'La revisión de los lunes y la frase de la semana son la rutina que diseñó el dueño para la Curva 13; el Manual de Operaciones no las menciona. Hasta que la Junta Directiva las escriba, cúmplelas como práctica de la operación, no como norma auditable.' },

      { t: 'sub', texto: 'Por qué cada fuente importa' },
      {
        t: 'tabla',
        encabezados: ['Si se atrasa…', 'Lo que le pasa a la curva'],
        filas: [
          ['Los extractos', 'Arranca de un saldo viejo y las 13 semanas heredan el error'],
          ['La bandeja Por clasificar', 'Un cobro sin clasificar no cuenta en el promedio ni en el balde del dueño: la proyección sale más baja'],
          ['Los pagos programados', 'Un pago nuevo que no se cargó no se descuenta: la semana sale mejor de lo que es'],
        ],
      },

      { t: 'sub', texto: 'La revisión de los lunes' },
      {
        t: 'pasos',
        items: [
          'Descarga los extractos de la semana de cada cuenta y súbelos uno por uno en Subir extracto. Lee el resumen antes de guardar.',
          'Si aparece el aviso de descuadre de St. Georges, el saldo ya se tomó del banco: baja el estado oficial y anota el movimiento que falta.',
          'Confirma que ninguna cuenta operativa quede con el aviso de saldo viejo, que sale a los 7 días.',
          'Vacía la bandeja Por clasificar. Meta: cero.',
          'Revisa los Pagos programados de las dos empresas y corrige los que cambiaron esa semana.',
          'Lee la curva en las tres vistas y escribe la frase de la semana.',
        ],
      },

      { t: 'sub', texto: 'La bandeja Por clasificar, bien hecha' },
      { t: 'p', texto: 'Cada movimiento se clasifica mirando el **detalle del banco**: quién recibe o quién paga, y a cambio de qué. Si el mismo proveedor o cliente va a volver a aparecer, marca **Crear regla con este texto** y la próxima vez se clasifica solo.' },
      { t: 'p', texto: 'El texto de la regla viene lleno con el principio del detalle del banco, y **casi siempre hay que corregirlo**. En Banco General casi todas las transferencias empiezan igual: "BANCA EN LINEA TRANSFERENCIA A" más un número de cuenta. Una regla con ese principio clasificaría igual a todo el que recibe una transferencia.' },
      {
        t: 'tabla',
        titulo: 'Cómo se escribe el texto de la regla',
        encabezados: ['Detalle del banco', 'Texto de la regla'],
        filas: [
          ['BANCA EN LINEA TRANSFERENCIA A 0397011382720 ELECTRONIC BUSINESS INTELLIGENCE, CORP Renova', 'ELECTRONIC BUSINESS INTELLIGENCE'],
          ['Una transferencia a una persona que cobra una sola vez', 'Ninguno: se clasifica sin regla'],
        ],
      },
      { t: 'p', texto: 'La regla necesita entre 3 y 80 caracteres. Sin tildes ni mayúsculas que cuidar: el sistema compara el texto sin acentos y en mayúsculas.' },
      { t: 'nota', tono: 'regla', titulo: 'Lo que no cambia la caja no entra a la curva', texto: 'El barrido de St. Georges a Banco General dentro de la misma empresa es Traspaso entre cuentas propias. La plata de campeonatos es Resguardo campeonatos C&C. Ninguno de los dos es ingreso ni egreso: contarlos inflaría el cobro o el gasto.' },

      { t: 'sub', texto: 'Los pagos programados' },
      { t: 'p', texto: 'La lista de Pagos programados es lo que la curva descuenta hacia adelante. Cada pago tiene su monto y su frecuencia: **mensual** con su día, **quincenal** el 15 y el último día del mes, **una sola vez** con su fecha o **anual**. Cuando un pago termina, se le pone fecha Hasta o se quita; si no, la curva lo sigue descontando para siempre.' },
      { t: 'p', texto: 'Los pagos marcados **(estimado)** salen del promedio de Zoho. Se corrigen con el monto real en cuanto llega la factura del mes.' },

      { t: 'sub', texto: 'Qué se hace con una semana en alerta' },
      {
        t: 'tabla',
        encabezados: ['Lo que ves', 'Lo que haces'],
        filas: [
          ['Una semana en ámbar', 'La nombras en la frase de la semana con el pago que la baja del piso'],
          ['Una semana en rojo', 'Sube a la Junta Directiva ese mismo día: semana, monto que falta y pago que la hunde'],
          ['La columna Línea con ⛔ excede la línea', 'Es la alerta más urgente: ni la línea de crédito alcanza. Se avisa el mismo día, por escrito'],
        ],
      },
      { t: 'p', texto: 'Tú **no** giras la línea de crédito, no mueves un pago y no cambias los baldes. Eso lo decide la Junta Directiva. Tu trabajo es que lo vea con semanas de anticipación, con los números en la mano.' },

      { t: 'sub', texto: 'La frase de la semana' },
      { t: 'p', texto: 'La frase lleva cinco piezas, en este orden: **la vista, la primera semana en alerta con su fecha, su disponible contra el piso, la línea que pide y el estado de las fuentes.**' },
      { t: 'p', texto: 'Ejemplo: "Consolidado: primera alerta en la semana 6, lunes 2 de noviembre, ámbar, disponible 8.400 contra un piso de 21.000; ninguna semana pide línea. Bandeja en cero, extractos al viernes." Si las 13 semanas están en verde, se dice así, con el piso: también es un dato.' },

      { t: 'sub', texto: 'Errores que cuestan dinero' },
      {
        t: 'lista',
        items: [
          'Crear una regla con el principio del detalle del banco: se traga todas las transferencias.',
          'Clasificar el barrido entre cuentas propias como ingreso o egreso.',
          'Ajustar el cobro de una semana por intuición, sin evidencia escrita.',
          'Dejar un pago que ya terminó en la lista: la curva lo sigue descontando.',
          'Mandar la frase sin haber subido los extractos de la semana.',
        ],
      },
    ],
    ...
    quiz: [
      {
        pregunta: 'Un cobro de un cliente se queda en Por clasificar. ¿Qué le pasa a la curva?',
        opciones: [
          'Nada: el saldo del banco ya lo incluye y la curva no cambia',
          'Se cuenta dos veces',
          'No entra al promedio de cobro ni al balde del dueño, y la proyección sale más baja',
          'La semana 1 sale en rojo',
        ],
        explicacion: 'El saldo sí lo incluye, pero la proyección se arma solo con lo clasificado como ingreso.',
        repasa: ['ingreso'],
      },
      {
        pregunta: 'El detalle del banco dice "BANCA EN LINEA TRANSFERENCIA A 0397011382720 ELECTRONIC BUSINESS INTELLIGENCE, CORP Renova". El texto de la regla es…',
        opciones: [
          'BANCA EN LINEA TRANSFERENCIA A',
          'ELECTRONIC BUSINESS INTELLIGENCE',
          'el detalle completo, tal cual',
          'Renova',
        ],
        explicacion: 'El texto de la regla es lo que distingue a ese proveedor. El principio es igual en casi todas las transferencias.',
        repasa: ['proveedor'],
      },
      {
        pregunta: 'La pantalla avisa saldo viejo cuando una cuenta operativa lleva…',
        opciones: [
          'más de 30 días sin movimientos',
          'un movimiento por clasificar',
          'un mes sin conciliar',
          'más de 7 días sin saldo del banco',
        ],
        explicacion: 'Con un saldo viejo, las 13 semanas arrancan de un número falso.',
        repasa: ['saldo'],
      },
      {
        pregunta: 'Una semana sale en rojo. Tú…',
        opciones: [
          'subes a la Junta Directiva ese mismo día con la semana, el monto que falta y el pago que la hunde',
          'giras de la línea de crédito lo que dice la columna Línea',
          'mueves el pago más grande a la semana siguiente',
          'esperas al cierre del mes para confirmarlo',
        ],
        explicacion: 'Tú avisas con anticipación; girar la línea o mover un pago lo decide la Junta Directiva.',
        repasa: ['junta-directiva'],
      },
      {
        pregunta: 'Los pagos programados marcados (estimado)…',
        opciones: [
          'no se descuentan en la curva',
          'salen del promedio de Zoho y se corrigen con el monto real en cuanto llega la factura',
          'los decide la Junta Directiva',
          'son pagos del dueño',
        ],
        explicacion: 'El estimado sirve para arrancar. El monto real es el que decide el color de la semana.',
        repasa: ['egreso'],
      },
      {
        pregunta: 'Sabes que la semana 1 va a cobrar 9.000 en total. Escribes 9.000 en el ajuste de la semana 1.',
        opciones: ['Verdadero', 'Falso'],
        explicacion: 'En la semana 1 el ajuste es de mañana al domingo: lo cobrado hasta hoy ya está en el saldo del banco y se contaría dos veces.',
      },
      {
        pregunta: 'Un proveedor dejó de cobrarse este mes y sigue en Pagos programados. ¿Qué pasa?',
        opciones: [
          'Nada: el sistema lo detecta solo',
          'La semana en que caía sale en rojo',
          'Se clasifica como traspaso',
          'La curva lo sigue descontando cada mes hasta que se le ponga fecha Hasta o se quite',
        ],
        explicacion: 'La lista es lo que la curva descuenta hacia adelante. Un pago muerto hace que las semanas salgan peor de lo que son.',
      },
      {
        pregunta: 'La frase de la semana lleva…',
        opciones: [
          'el saldo de hoy y el total cobrado del mes',
          'la vista, la primera semana en alerta con su fecha, su disponible contra el piso, la línea que pide y el estado de las fuentes',
          'la lista completa de pagos programados',
          'solo el color de la semana 13',
        ],
        explicacion: 'Si las 13 semanas están en verde, se dice así, con el piso: también es un dato.',
        repasa: ['veraz'],
      },
    ],
    ...
    drills: [
      {
        titulo: 'Maniobra 1 — La revisión del lunes, de punta a punta',
        fuente: 'app/dashboard/caja/page.js',
        proposito: 'Que hagas la revisión de un lunes en la pantalla real —extractos, bandeja, pagos programados y frase— y entregues la frase de la semana sin un número inventado.',
        gradiente: 'Exige of-cop-11 estudiado y firmado: sin saber leer la curva no se puede mantenerla. Se hace un lunes de verdad, con los extractos de esa semana; si tu usuario no entra a la caja, se hace a la par de quien sí tiene acceso.',
        masa: [
          'Los extractos de la semana de todas las cuentas operativas.',
          'La pantalla Curva 13 · Caja con su bandeja Por clasificar.',
          'La frase de la semana anterior.',
        ],
        pasos: [
          'Sube los extractos de la semana y di en voz alta el resumen de cada uno antes de guardar.',
          'Confirma que ninguna cuenta operativa quedó con aviso de saldo viejo.',
          'Clasifica la bandeja movimiento por movimiento, diciendo la clase y por qué.',
          'Crea al menos una regla y muestra que su texto es el nombre que distingue al proveedor o cliente.',
          'Revisa los Pagos programados de las dos empresas y corrige lo que cambió esa semana.',
          'Escribe la frase de la semana con sus cinco piezas y compárala con la de la semana anterior.',
        ],
        criterios: [
          'Termina con la bandeja Por clasificar en cero, sin haber adivinado la clase de ningún movimiento.',
          'Toda regla que crea usa el nombre que distingue al proveedor, nunca el principio del detalle del banco.',
          'Clasifica los barridos entre cuentas propias como traspaso y explica por qué no son ingreso.',
          'La frase lleva las cinco piezas en su orden y cada número coincide con la pantalla.',
          'Ante una semana en rojo, dice qué sube a la Junta Directiva y no propone girar la línea por su cuenta.',
        ],
        errorTipico: 'Aceptar el texto de la regla tal como viene lleno. Empieza con BANCA EN LINEA TRANSFERENCIA A y el número de cuenta, y la próxima transferencia a cualquier otra persona cae en la misma clase sin que nadie la mire.',
      },
    ],
  },
]
