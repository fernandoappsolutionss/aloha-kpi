...
export const MODULOS = [
  ...
  },
  {
    ...
    errores: [
      ...
      { sintoma: 'Quiero comparar Clases de Prueba con el KPI.', causa: 'Debes comparar el mismo mes. Matriculados y Pagados tienen fuentes distintas.', arreglo: 'En KPI pulsa Ver clases realizadas de este mes. Con el filtro Realizadas, Invitados coincide con Registrados y Asistieron con Asistieron; los registros de clases futuras quedan en Próximas. Matriculados cuenta ventas del mes provenientes de prueba; Pagados refleja pagos registrados en el CRM. Un KPI cerrado conserva la foto del cierre.' },
    ],
  },
  {
    id: 'inscribir',
