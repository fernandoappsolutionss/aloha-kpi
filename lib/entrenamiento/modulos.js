...
export const MODULOS = [
  ...
  },
  {
    ...
    quiz: [
      { pregunta: 'Un grupo sin itinerario cargado…', opciones: ['Funciona igual: el itinerario es solo informativo', 'Se cierra solo al final del mes', 'Es ciego: sin lista de la coach ni control de llenado', 'No puede tener coach asignada hasta que alguien lo cargue'], explicacion: 'Del itinerario salen la lista de la coach, la ventana de nuevos y el cierre. Sin él, no hay nada de eso.' },
      { pregunta: '¿Qué hace "Ajustar itinerario"?', opciones: ['Reconstruye el plan completo del grupo', 'Solo cambia la coach del grupo sin tocar el plan', 'Cambia el nombre y el número con que se ve el grupo', 'Cierra el nivel en curso'], explicacion: 'Nivel, fecha de inicio y clases suspendidas: por eso se usa con cuidado y con la planificación real a la vista.' },
