...
export const MODULOS = [
  ...
  },
  {
    ...
    errores: [
      ...
      { sintoma: 'No veo las clases del mes pasado.', causa: 'El periodo abre en Este mes.', arreglo: 'En Clases de Prueba selecciona Mes pasado o Elegir mes. Las tarjetas muestran los registros de las clases fechadas en ese mes, incluidos los cancelados.' },
      { sintoma: 'Quiero comparar Clases de Prueba con el KPI.', causa: 'Debes comparar el mismo mes. Matriculados y Pagados tienen fuentes distintas.', arreglo: 'En KPI pulsa Ver clases de este mes. Invitados coincide con Registrados y Asistieron con Asistieron. Matriculados cuenta ventas del mes provenientes de prueba; Pagados refleja pagos registrados en el CRM. Un KPI cerrado conserva la foto del cierre.' },
    ],
  },
  {
    id: 'inscribir',
