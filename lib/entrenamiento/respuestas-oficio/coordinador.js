...
// `coordinacion`, módulos of-cop-1 … of-cop-12).
//
...
export const RESPUESTAS_COORDINACION = {
  ...
  // 1 noventa · 2 todas a favor del centro · 3 copia del mes anterior
  ...
  // 6 recibido de copia · 7 once documentos · 8 autorización escrita y firmada
  ...
  // 1 la primera que no alcanza · 2 lunes de esta semana y se corre sola · 3 saldo final menos reserva
  // 4 bajo el piso · 5 de mañana al domingo · 6 últimos 3 meses cerrados · 7 Falso · 8 traspaso propio
  'of-cop-11': [2, 0, 1, 3, 0, 1, 1, 2],

  // 1 no entra al promedio · 2 el nombre del proveedor · 3 más de 7 días · 4 sube a la Junta
  // 5 se corrigen con el monto real · 6 Falso · 7 lo sigue descontando · 8 las cinco piezas
  'of-cop-12': [2, 1, 3, 0, 1, 1, 3, 1],
}
