...
export const RESPUESTAS_CENTRO = {
  // La 7ª (índice 6) no sale del banco: es la escena del padre que trae la
  // regla pedagógica del Manual y la factura con dos números distintos de "ciclo". El GIFT es
  // anterior a la separación de los dos sentidos, así que su índice se puso
  // a mano; las 8 del banco se conservan en su orden.
  'of-cen-1': [1, 0, 0, 2, 1, 0, 1, 3, 2],
