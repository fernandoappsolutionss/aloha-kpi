...
const CATALOGO = {
  ...
  cp_classification_incomplete: {
    titulo: 'Ventas sin clasificar',
    accion: 'Cada venta necesita su origen (clase de prueba o directa) y su ficha registrada. Sin eso, la matrícula de prueba se toma de lo declarado a mano.',
    destino: 'kpi',
...
export function higieneDeDatos({
  ...
  // 6 · CAPACIDAD SIN VERIFICAR. Va al final y marcada como de Dirección: el
  // centro no tiene dónde declararla y verla arriba todos los días la
  // convertiría en papel tapiz. Ver lib/growth/source.mjs:230.
  ...
  if (capacidad) {
    ...
    lista.push({
      ...
      titulo: 'Capacidad física sin verificar',
      accion: `Hoy la capacidad se estima${cupo ? ` (${cupo})` : ''} sin contrastarla con horarios, salones y coaches. Mientras el producto no permita declararla verificada, ningún centro llega a confianza alta.`,
      items: [],
      cuantos: 1,
      bloquea: false,
      ganancia: 0,
