...
export function cuadroConBalanceDeclarado({ datos, inicio, nuevosActivos, reincorporados, retirados }) {
  ...
  const totales = {
    ...
    aPagar: Math.max(0, balanceMensual({ inicio, nuevosActivos, reincorporados, retirados })),
  }
  return {
    ...datos,
    totales,
