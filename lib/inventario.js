...
// clases debe haber ~15 minutos, y un grupo ocupa bloques de 1 h o 2 h.
...
// Ventana VENDIBLE (demanda real, regla de Fernando 2026-08-10): entre semana
// las clases corren DESDE LAS 4:00 PM; el sábado las jornadas van de 9 am a
// 5 pm. Las horas operativas fuera de esta ventana son "horas muertas":
// existen, pero no cuentan como inventario para crecer.
export const INICIO_VENDIBLE_SEMANA = 16 * 60 // 4:00 pm
// Zona Kinder entre semana: 2:45–3:45 pm. Los preescolares salen temprano y
// aprovechan ese espacio; los horarios calientes se reservan para Tiny/Kids.
// El cierre encaja exacto con la parrilla: 3:45 + 15 min de buffer = 4:00 pm.
export const KINDER_INICIO = 14 * 60 + 45
export const KINDER_FIN = 15 * 60 + 45
...
export const BUFFER_MIN = 15             // espacio entre clases en el mismo salón (ajuste 2026-08: era 30)
...
// ¿Dos sesiones chocan en el mismo salón? (solape real o sin el buffer de espacio)
