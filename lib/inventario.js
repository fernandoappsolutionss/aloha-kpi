...
export const INICIO_VENDIBLE_SEMANA = 15 * 60 + 30 // 3:30 pm (primer slot del modelo; las 3:00 en punto daban problema)
// Zona Kinder entre semana: 2:00–3:30 pm. Los preescolares salen temprano y
// aprovechan ese espacio; los horarios calientes se reservan para Tiny/Kids.
export const KINDER_INICIO = 14 * 60
export const KINDER_FIN = 15 * 60 + 30
