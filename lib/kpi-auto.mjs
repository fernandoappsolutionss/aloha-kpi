...
import { filtrarClasesPorMes, resumirClases } from './clases-prueba.mjs'
...
export function fuenteKpiAutomatica({ year, month, clases = [], ventas = [], retiros = [], timeZone = 'America/Panama' }) {
  ...
  const totals = resumirClases(clasesMes)
  ...
  source._trial_attendance = { basis: 'event_month', month: mes, classes: clasesMes.length }
