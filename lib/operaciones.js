...
export const ESTADOS_ESTUDIANTE = ['activo', 'baja_potencial', 'retirado', 'matricula_anulada']
...
export const TIPOS_EVENTO = ['inscripcion', 'cambio_grupo', 'fusion', 'cambio_nivel', 'baja_potencial', 'retiro', 'reincorporacion', 'graduacion_tiny', 'retiro_programado', 'retiro_cancelado', 'anulacion_matricula', 'reverso_matricula']

// De dónde entró el niño: clase de prueba, inscripción directa, traslado o reincorporación.
export const ORIGENES = ['clase_prueba', 'directo', 'traslado', 'reincorporado']
