...
export function preparaFijadoAncla({ ninos, ids, ancla } = {}) {
  ...
  const anulado = filas.find((n) => n.estado === 'matricula_anulada')
  if (anulado) return { error: `${anulado.nombre} tiene la matrícula anulada y no admite cambios de inicio de nivel.` }
