  ...
  if (!exacta.length) {
    ...
    if (inicioMin < vi || inicioMin >= vf) {
      ...
      razon = esSabado(dia)
        ...
        : 'Entre semana antes de las 3:30 pm casi no se vende: los niños salen del colegio ~1:00 pm y la parrilla del modelo arranca a las 3:30 pm (zona Kinder: 2:00–3:30).'
    }
  }
