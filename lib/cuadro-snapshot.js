...
import { grupoYaDioClases, iniciosClaseMes, retirosActivosMes, usaIniciosClaseOperativos } from './inicios-clase.mjs'
...
export async function calcularCuadro(centroId, y, m, query = sql) {
  ...
  // Un grupo de nivel 2+ ya dio su primera clase (grupoYaDioClases): su
  // fecha_inicio_clases es el arranque del nivel vigente, no el del grupo, así
  // que jamás debe sacarlo del cuadro por "estar en llenado".
