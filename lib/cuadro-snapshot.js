...
import { estudiantesConInicioAlCierre, iniciosClaseMes, retirosActivosMes, usaIniciosClaseOperativos } from './inicios-clase.mjs'
...
export async function calcularCuadro(centroId, y, m, query = sql) {
  ...
  const estudiantes = usaIniciosOperativos
    ? estudiantesConInicioAlCierre(todosEst, todos, todosEventos, y, m)
    : todosEst
