...
// adelante el grupo nace CERRADO a nuevos: para colocar un traslado que ya viene
// en ese nivel se abre la palanca a mano (setInscripcionAbierta), que es una
// decisión consciente y queda con rastro.
