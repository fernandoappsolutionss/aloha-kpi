...
export function invitacionHtml({ nombre, link, tipo }) {
  ...
  return `<div style="font-family:Arial,Helvetica,sans-serif;max-width:480px;margin:0 auto;color:#1a2744;padding:8px">
    ...
    <p style="margin:24px 0"><a href="${link}" style="background:#10B981;color:#fff;padding:12px 22px;border-radius:8px;text-decoration:none;font-weight:600;display:inline-block">${cta}</a></p>
    <p style="font-size:12px;color:#888;line-height:1.5">O copia este enlace en tu navegador:<br><a href="${link}" style="color:#10B981">${link}</a></p>
