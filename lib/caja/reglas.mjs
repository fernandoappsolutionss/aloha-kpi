...
export const REGLAS_SEMILLA = Object.freeze([
  ...
  // F&F (extractos ene–sep 2026 y Fernando, 24-sep).
  R(50, 'INDALUZ', 'alquiler', 'Alquiler (Indaluz)', { empresa: 'ff', ...EGRESO }),
  R(50, 'BG TRUST INC. FID', 'alquiler', 'Alquiler (fideicomiso BG Trust)', EGRESO),
  ...
  // Después de COMISION: "COMISION IMPUESTO CSS (CAJA DE SEGURO SOCIAL)" es cargo del banco.
