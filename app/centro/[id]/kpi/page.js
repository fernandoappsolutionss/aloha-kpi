          ...
          {[
            ...
            <div key={title} className="panel">
              ...
              <div style={{ padding: 14 }}>
                ...
                {title === 'Clase de Prueba' && <Link className="btn" style={{ marginBottom: 12 }} href={`/centro/${id}/eventos?mes=${year}-${String(month).padStart(2, '0')}`}>Ver clases de este mes</Link>}
                {fields.map(([lbl,key]) => {
