...
-- ─────────────────────────────────────────────────────────────
-- Conciliador bancario Zoho.
-- Copia idéntica de db/migrations/2026-08-22-conciliacion-zoho.sql: schema.sql
-- se pega entero en el editor SQL de Neon, así que no puede usar \i. Tampoco
-- admite bloques plpgsql: scripts/migrate.mjs parte este archivo por ';' y un
-- bloque con punto y coma interno lo rompería (42601). Por eso los CHECK van
-- en línea dentro del CREATE TABLE.
-- ─────────────────────────────────────────────────────────────
